<form method="POST" action="<?php echo base_url('MenuDocPI/upload31/'.$getrowspi_value->sign_pi_noid); ?>" enctype="multipart/form-data" class="form-pi">
    <div class="form-group">
        ...
        <div class="col-md-2">
            <input type="date" class="form-control" name="date31" id="inputDefault" value="<?php echo $getrowspi_value->sign_toppay_balance_date ?>" <?=($groupname->GroupDesc == 'FINANCE'?'':'disabled')?> >
        </div>
