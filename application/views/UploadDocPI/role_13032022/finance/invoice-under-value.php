<form method="POST" action="<?php echo base_url('MenuDocPI/upload10/'.$getrowspi_value->sign_pi_noid); ?>" enctype="multipart/form-data" class="form-pi">
    <div class="form-group">
        ...
        <div class="col-md-2">
            <input type="date" class="form-control" name="date10" value="<?php echo $getrowspi_value->sign_invoice_underval_date ?>" id="inputDefault" <?=($groupname->GroupDesc == 'FINANCE'?'':'disabled')?> >
        </div>
        <div class="col-md-2">
