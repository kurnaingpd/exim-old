<form method="POST" action="<?php echo base_url('MenuDocPI/upload26/'.$getrowspi_value->sign_pi_noid); ?>" enctype="multipart/form-data" class="form-pi">
    <div class="form-group">
        ...
        <div class="col-md-2">
            <input type="date" class="form-control" name="date26" id="inputDefault" value="<?php echo $getrowspi_value->sign_stuffing_date ?>" <?=($groupname->GroupDesc == 'WAREHOUSE'?'':'disabled')?> >
        </div>
        <div class="col-md-2">
