<form method="POST" action="<?php echo base_url('MenuDocPI/upload08/'.$getrowspi_value->sign_pi_noid); ?>" enctype="multipart/form-data" class="form-pi">
    <div class="form-group">
        ...
        <label class="col-md-1" for="inputDefault"></label>
        <div class="col-md-2">
            <input type="date" class="form-control" name="date08" value="<?php echo $getrowspi_value->sign_packing_list_date ?>" id="inputDefault" <?=($groupname->GroupDesc == 'WAREHOUSE'?'':'disabled')?> >
        </div>
        <div class="col-md-2">
            <input type="file" class="form-control" name="berkas" id="inputDefault" <?=($groupname->GroupDesc == 'WAREHOUSE'?'':'disabled')?> >
        </div>
        <div class="col-md-2">
