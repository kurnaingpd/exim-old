<form method="POST" action="<?php echo base_url('MenuDocPI/upload07/'.$getrowspi_value->sign_pi_noid); ?>" enctype="multipart/form-data" class="form-pi">
    <div class="form-group">
        ...
        <label class="col-md-1" for="inputDefault"></label>
        <div class="col-md-2">
            <input type="date" class="form-control" name="date07" value="<?php echo $getrowspi_value->sign_bill_of_ladding_date ?>" id="inputDefault" <?=($groupname->GroupDesc == 'PROCUREMENT'?'':'disabled')?> >
        </div>
        <div class="col-md-2">
            <input type="file" class="form-control" name="berkas" id="inputDefault" <?=($groupname->GroupDesc == 'PROCUREMENT'?'':'disabled')?> >
        </div>
        <div class="col-md-2">
