<form method="POST" action="<?php echo base_url('MenuDocPI/upload23/'.$getrowspi_value->sign_pi_noid); ?>" enctype="multipart/form-data" class="form-pi">
    <div class="form-group">
        ...
        <div class="col-md-2">
            <input type="date" class="form-control" name="date23" id="inputDefault" value="<?php echo $getrowspi_value->sign_vesselsche_date ?>" <?=($groupname->GroupDesc == 'PROCUREMENT'?'':'disabled')?> >
        </div>
