...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>SIGN PI : Listing Data COA</h5>
							</header>
							<div class="panel-body">

<a class="btn btn-warning" style="width: 150px;" href="<?php echo base_url('MenuDocPI/reloadsignpi/'.$signpi_id);?>"> Back </a>
<hr>
...
<?php
if(!empty($lscoafile_bypi)){
  // Jika data pada database tidak sama dengan empty (alias ada datanya)
$no_urut=1;
  foreach($lscoafile_bypi as $gaa){
    echo "<tr>";
	echo "<th scope='row'>".$no_urut++."</th>";
    echo "<td>".$gaa->coa_detsign_date."</td>";
    echo "<td>".$gaa->coa_detsign_path."</td>";
	...
	// 	}
	// echo"</td>";
	echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("MenuDocPI/DownloadFile_Coadet/".$gaa->coa_detsign_id)."'><i class='fa fa-download'></i></a></td>";
