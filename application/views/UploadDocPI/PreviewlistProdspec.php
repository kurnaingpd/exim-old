...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>SIGN PI : Listing Data Product Specification</h5>
							</header>
							<div class="panel-body">

	<a class="btn btn-warning" href="<?php echo base_url('MenuDocPI/reloadsignpi/'.$signpi_id);?>" style="width:150px;"> Back </a>
<hr>
	<p>PI Numbers : <?php echo $getrowspi_value->sign_pi_no; ?></p>
<hr>
...
<?php
if(!empty($lsprodsfile_bypi)){
  // Jika data pada database tidak sama dengan empty (alias ada datanya)
$no_urut=1;
  foreach($lsprodsfile_bypi as $gaa){
    echo "<tr>";
	echo "<th scope='row'>".$no_urut++."</th>";
    echo "<td>".$gaa->prodspec_date."</td>";
    echo "<td>".$gaa->prodspec_val."</td>";
	...
	// 	}
	// echo"</td>";
	echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("MenuDocPI/DownloadFile_Prodspec/".$gaa->prodspec_signid)."'><i class='fa fa-download'></i></a></td>";
