<form method="POST" action="<?php echo base_url('MenuDocPI/upload21/'.$getrowspi_value->sign_pi_noid); ?>" enctype="multipart/form-data" class="form-pi">
    <div class="form-group">
        ...
        <div class="col-md-2">
            <input type="date" class="form-control" name="date21" id="inputDefault" value="<?php echo $getrowspi_value->sign_posm_date ?>" <?=($groupname->GroupDesc == 'PPIC'?'':'disabled')?> required>
        </div>
