<form method="POST" action="<?php echo base_url('MenuDocPI/upload12/'.$getrowspi_value->sign_pi_noid); ?>" enctype="multipart/form-data" class="form-pi">
    <div class="form-group">
        ...
        <label class="col-md-1" for="inputDefault"></label>
        <div class="col-md-2">
            <input type="date" class="form-control" name="date12" value="<?php echo $getrowspi_value->sign_healthcert_date ?>" id="inputDefault" <?=($groupname->GroupDesc == 'QA'?'':'disabled')?> required>
        </div>
        <div class="col-md-2">
