<form method="POST" action="<?php echo base_url('MenuDocPI/upload25/'.$getrowspi_value->sign_pi_noid); ?>" enctype="multipart/form-data" class="form-pi">
    <div class="form-group">
        ...
        <div class="col-md-2">
            <input type="date" class="form-control" name="date25" id="inputDefault" value="<?php echo $getrowspi_value->sign_vesselbookconf_date ?>" <?=($groupname->GroupDesc == 'PROCUREMENT'?'':'disabled')?> required>
        </div>
