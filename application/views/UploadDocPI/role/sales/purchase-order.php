<form method="POST" action="<?php echo base_url('MenuDocPI/upload02/'.$getrowspi_value->sign_pi_noid); ?>" enctype="multipart/form-data" class="form-pi">
    <div class="form-group">
        ...
        <div class="col-md-2">
            <input type="date" name="date02" value="<?php echo $getrowspi_value->sign_pi_po_date ?>" class="form-control" id="inputDefault" <?=($groupname->GroupDesc == 'SALES'?'':'disabled')?> required>
        </div>
        <div class="col-md-2">
