...
<div class="container-fluid">
 									<form method="POST" action="<?php echo base_url('MenuDocPI/checksignPI/');?>">
											<label class="col-md-1" for="inputDefault">PI Number</label>
												<div class="col-md-3">
													...
													<label class="col-md-1" for="inputDefault">PI Selected </label>
												<div class="col-md-2">
													<!-- <select id="basic" data-plugin-selectTwo class="form-control" name="customercountry">
															<option value="">%</option>
                                                    </select> -->
													<input type="text" class="form-control" id="inputDefault" placeholder="%" disabled>
												</div>
												<label class="col-md-1" for="inputDefault">PI Progress </label>
												<div class="col-md-2">
													<!-- <select id="basic" data-plugin-selectTwo class="form-control" name="customercountry">
															<option value="">%</option>
                                                    </select> -->
