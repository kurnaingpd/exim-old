...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Master Data Set : Master Set TOP</h5>
							</header>
    ...
    <div class="modal-content">
	  ...
	  <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetTop/createnewtop');?>" id="inputdatagroup" method="POST">
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="topdesc" data-plugin-maxlength maxlength="50" autofocus autocomplete="off" required style="text-transform: uppercase" />
													<p>
...
$no_urut=1;
  foreach($lsmastertop as $gaa){
    ...
    echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("DataSetTop/Editmastertop/".$gaa->TopId)."'><i class='fa fa-pencil-square-o'></i></a></td>";
    echo "</tr>";
  }
