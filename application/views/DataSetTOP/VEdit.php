...
<section class="panel panel-warning">
            ...
            <header class="panel-heading">
                ...
                <h5 style="color: white;">Master Data Set : Master Set TOP</h5>

            </header>
            <div class="panel-body">

            <a style="margin-bottom: 25px;" class="mb-md mt-xs mr-xs btn btn-warning" href="<?php echo base_url('DataSetTop/');?>">Back</a>
...
<form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetTop/submiteditmastertop');?>" id="inputdatagroup" method="POST">

                    <input type="hidden" value="<?php echo $lsmastertop[0]->TopId ?>" name="topid">
                           
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="textareaDefault">TOP Description</label>
                                <div class="col-md-8">
                                    <input class="form-control" name="topdesc" value="<?php echo $lsmastertop[0]->TopDesc ?>" data-plugin-maxlength maxlength="50" autofocus autocomplete="off" required style="text-transform: uppercase" />
                                    <p>
                                        <code>*</code>.
                                    </p>
                                </div>
                            ...
                            <div class="form-group">
												...
												<div class="col-md-8">
													<select id="basic" data-plugin-selectTwo class="form-control" name="topstats">
                                                            <option value="<?php echo $lsmastertop[0]->TopStats ?>"><b>Selected : </b><?php if($lsmastertop[0]->TopStats=='1'){
                                                                echo "Active";
                                                            }else{
                                                                echo "InActive";
                                                            } ?></option>
