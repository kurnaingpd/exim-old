      ...
      <div class="modal-body">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-8">
                                                    ...
                                                    <select id="basic" data-plugin-selectTwo class="form-control">
...
<div id="modalAnim" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
    <section class="panel panel-success">
        <header class="panel-heading">
            <h2 class="panel-title">Create New Users</h2>
        </header>
        <div class="panel-body">
            <div class="modal-wrapper">


            <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('MasterUser/createnewuser');?>" id="inputdatagroup" method="POST">
								
											<div class="form-group">
												<label class="col-md-3 control-label">Pilih Group</label>
												<div class="col-md-8">
													<!-- <select id="basic-single" data-plugin-selectTwo class="form-control populate" name="usergroup">
													<option value="">-- Pilih --</option>
														<optgroup label="Set Group"> -->
														<!-- <option value="">-- Pilih --</option> -->
												...
												<?php endforeach; ?> -->
                                                    ...
                                                    <!-- <input name="vdn_number" data-plugin-selectTwo type="hidden" id="basic"  class="input-large" required=""  /> -->
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Username</label>
												<div class="col-md-8">
													<input class="form-control" name="username" data-plugin-maxlength maxlength="50" />
													<p>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="userpassword" data-plugin-maxlength maxlength="50" />
													<!-- <p>
														<code>max-length</code> set to 50 character <code>lowercase</code>.
													</p> -->
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="accountname" data-plugin-maxlength maxlength="50" />
													<p>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="useremail" data-plugin-maxlength maxlength="50" />
													<!-- <p>
														<code>max-length</code> set to 50 character.
													</p> -->
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="userphone" data-plugin-maxlength maxlength="12" />
													<!-- <p>
														<code>max-length</code> set to 50 character.
													</p> -->
												</div>
