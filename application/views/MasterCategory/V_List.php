...
<br>
							<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('MasterCategory/filter_search_data'); ?>">
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" name="categori_id" class="form-control" id="inputDefault">
												</div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-1" for="inputDefault"></label>
												...
												<div class="col-md-3">
													<input type="text" name="categori_name" class="form-control" id="inputDefault">
												</div>
											</div>
