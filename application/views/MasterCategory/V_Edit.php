...
<a class="mb-xs mt-xs mr-xs btn btn-warning" href="<?php echo base_url('MasterCategory/'); ?>" style="width:150px;"><i class="fa fa-arrow-left"></i> Back</a>
<!-- <a class="mb-xs mt-xs mr-xs btn btn-primary" href="<?php echo base_url('MasterCategory/tambah_data'); ?>"><i class="fa fa-save"></i>  Simpan</a> -->
...
<div class="row">
<br>
<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('MasterCategory/submit_edit_data'); ?>">

<input type="hidden" name="categori_id" value="<?php echo $rows_category->mt_categori_id ?>" class="form-control" id="inputDefault" required>

                                            
											<div class="form-group">
                                                <label class="col-md-1" for="inputDefault"></label>
												<label style="font-weight: 600; color:black; border-style:solid; border-color:#172774; padding:10px; border-width:0.5px; background-color:white;" class="col-md-12" for="inputDefault">Edit Master Category</label>
												<!-- <div class="col-md-3">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" name="catname" value="<?php echo $rows_category->mt_categori_name ?>" class="form-control" id="inputDefault" required>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<select id="basic" data-plugin-selectTwo class="form-control" name="status" required>
															<option value="<?php echo $rows_category->mt_categori_stats ?>">Selected : <?php if($rows_category->mt_categori_stats=='1'){
                                                                echo "Active";
                                                            }else{
                                                                echo "Not Active";
                                                            } ?></option>
