...
th, td { white-space: nowrap; font-weight: 400; color:black; }
        ...
        <!-- start: header -->
			<header class="header" >
				<div class="logo-container">
					<a href="#" class="logo">
						<img src="<?= base_url(); ?>assets/images/gexim-new-icc.png" style="height:40px; margin-top:-5px;" alt="Gonusa" />
					</a>
...
<!-- <a class="mb-xs mt-xs mr-xs btn btn-warning" href="<?php echo base_url('MasterCategory'); ?>"><i class="fa fa-arrow-left"></i>  Back to All</a> -->
<a class="mb-xs mt-xs mr-xs btn btn-primary" href="<?php echo base_url('MasterCategory/tambah_data'); ?>"><i class="fa fa-plus-circle"></i>  Tambah Data</a>

<!-- <div class="container"> -->
<div class="row">
<br>
							<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('MasterCategory/filter_search_data'); ?>">
                                            
											<div class="form-group">
                                                <label class="col-md-1" for="inputDefault"></label>
												<label style="font-weight: 600; color:black;" class="col-md-1" for="inputDefault">Category ID</label>
												<div class="col-md-3">
													<input type="text" name="categori_id" value="<?php echo $params1 ?>" class="form-control" id="inputDefault">
												</div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-1" for="inputDefault"></label>
												<label style="font-weight: 600; color:black;" class="col-md-1" for="inputDefault">Category Name</label>
												<div class="col-md-3">
													<input type="text" name="categori_name" value="<?php echo $params2 ?>" class="form-control" id="inputDefault">
												</div>
											</div>
...
$no_urut=1;
  foreach($searchbydata as $gaa){ ?>
                                    ...
                                    <tr>
										<td> 
											<a style="margin-right: 10px;" role="menuitem" class="mb-xs mt-xs mr-xs modal-with-zoom-anim btn btn-danger" tabindex="-1" href="#modalDelete<?php echo $gaa->mt_categori_id; ?>"><i class="fa fa-trash-o"></i></a>
										 <!-- Modal Animation -->
											<div id="modalDelete<?php echo $gaa->mt_categori_id; ?>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
											<section class="panel panel-danger">
												...
												<div class="panel-body">
													<div class="modal-wrapper">
														...
														<form action="<?php echo base_url('MasterCategory/submit_delete_data'); ?>" method="POST">
															<input type="hidden" value="<?php echo $gaa->mt_categori_id; ?>" name="categori_id">
															<p>Apakah anda yakin ingin menghapus data ini ?</p>
															<strong><p><?php echo $gaa->mt_categori_id; ?>, <?php echo $gaa->mt_categori_name; ?></p></strong>
														</div>
													</div>
												</div>
												<footer class="panel-footer">
											...
											<a style="margin-right: 10px;" role="menuitem" class="mb-xs mt-xs mr-xs modal-with-zoom-anim btn btn-warning" tabindex="-1" href="#modalEdit<?php echo $gaa->mt_categori_id; ?>"> <i class="fa fa-pencil-square-o"></i></a>
											<!-- Modal Animation -->
											<div id="modalEdit<?php echo $gaa->mt_categori_id; ?>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
											<section class="panel panel-warning">
												...
												<div class="panel-body">
													<div class="modal-wrapper">
														...
														<div class="modal-text" style="color:black; font-size:14px; padding:5px; margin-top:-20px; ">
														<form action="<?php echo base_url('MasterCategory/edit_master_category'); ?>" method="POST">
															<input type="hidden" value="<?php echo $gaa->mt_categori_id; ?>" name="categori_id">
                                        ...
                                        <td><?php echo $gaa->mt_categori_id; ?></td>
                                        <td><?php echo $gaa->mt_categori_name; ?></td>
                                        <td><?php if($gaa->mt_categori_stats=='1'){
