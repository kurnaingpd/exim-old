...
<table class="table table-bordered table-light mb-none" id="tables3">
                                    ...
                                    <tr>
										<td> 
											<a style="margin-right: 10px;" role="menuitem" class="mb-xs mt-xs mr-xs modal-with-zoom-anim btn btn-danger" tabindex="-1" href="#modalDelete"><i class="fa fa-trash-o"></i></a>
										 <!-- Modal Animation -->
												...
												<div class="panel-body">
													<div class="modal-wrapper">
														...
														<div class="modal-text" style="color:black; font-size:14px; padding:5px; margin-top:-20px; ">
															...
															<strong><p>1, Category Name</p></strong>
														</div>
													</div>
												</div>
												<footer class="panel-footer">
													<div class="row">
														<div class="col-md-12 text-right">
															<a href="<?php echo base_url('LoginImport/doLogout'); ?>" class="btn btn-danger">Ya, Hapus</a>
											...
											<a class="btn btn-warning"> <i class="fa fa-pencil-square-o"></i></a>
										</td>
                                        <td>1</td>
                                        <td>-</td>
                                        <td>-</td>
                                    ...
                                    <tr>
                                        <td>
											<a style="margin-right: 10px;" role="menuitem" class="mb-xs mt-xs mr-xs modal-with-zoom-anim btn btn-danger" tabindex="-1" href="#modalDelete2"><i class="fa fa-trash-o"></i></a>
											<!-- Modal Animation -->
											<div id="modalDelete2" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
											<section class="panel panel-danger">
												<header class="panel-heading" style="color:white;">
													<h2 class="panel-title">Delete Data</h2>
												</header>
												<div class="panel-body">
													<div class="modal-wrapper">
														...
														<div class="modal-text" style="color:black; font-size:14px; padding:5px; margin-top:-20px; ">
															<p>Apakah anda yakin ingin menghapus data ini ?</p>
															<strong><p>2 , Category Name</p></strong>
														</div>
													</div>
												</div>
												<footer class="panel-footer">
