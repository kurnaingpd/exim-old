...
<a class="mb-xs mt-xs mr-xs btn btn-warning" style="width:150px;" href="<?php echo base_url('MasterCategory/'); ?>"><i class="fa fa-arrow-left"></i> Back</a>
...
<div class="row">
<br>
<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('MasterCategory/submit_tambah_data'); ?>">
											...
											<div class="form-group">
												...
												<label style="font-weight: 600; color:black; border-style:solid; border-color:#172774; padding:10px; border-width:0.5px; background-color:white;" class="col-md-12" for="inputDefault">Tambah Master Category</label>
												<!-- <div class="col-md-3">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" name="catname" class="form-control" id="inputDefault" required>
												</div>
                                            </div>
