...
<a class="btn btn-warning" href="<?php echo base_url('MenuQCert/');?>"> Back</a>

</div>

							<hr>

							<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('MenuQCert/save_master_qs');?>">

											<div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">Quality Certificate No</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" value="<?php echo $noticket."/SKP-QS/".$m."/".$y.""; ?>" disabled>
													<input type="hidden" class="form-control" id="inputDefault" name="qs_no" value="<?php echo $noticket."/SKP-QS/".$m."/".$y.""; ?>">
												</div>
											</div>

											<!-- <div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">Quality Certificate Date</label>
												<div class="col-md-2">
											...
											<div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">QA No</label>
												<div class="col-md-3">
													<select id="input_coa_id" class="form-control" name="input_coa_id" required>
															<option value="">-- Pilih --</option>
														<?php foreach($lsmastercoa as $dt) : ?>
															<option value="<?php echo $dt->gexp_coa_id;?>"><?php echo $dt->gexp_coa_no;?></option>
														<?php endforeach; ?>
                                                    </select>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<!-- <input type="text" class="form-control" id="input_invoice" name="input_invoice" disabled> -->
													<select id="input_invoice" name="input_invoice" class="form-control" required>
															<option value="">-- Pilih --</option>
...
$("#input_coa_id").change(function(){
        var i;
        var coa_id = $("#input_coa_id").val();

        $('#input_invoice').val();
        $.post("<?=base_url()?>MenuQCert/get_invoice_bycoaid",{
            post_data:coa_id,
        },function(data){
            value = $.parseJSON(data);
			$.each(value,function(i,val){
               $('<option>').val(val.Invoice_Id).text(val.Invoice_No).appendTo('#input_invoice');
            })
        });
});
