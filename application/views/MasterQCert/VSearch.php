...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Dashboard : Quality Certificate </h5>
							</header>
							<div class="panel-body">

<div class="container-fluid">

<a class="btn btn-success" href="<?php echo base_url('MenuQCert/create_new_qcert'); ?>"><i class="fa fa-file"></i> New</a>

</div>

							<hr>

							<form class="form-horizontal form-bordered" method="post" action="<?php echo base_url('MenuQCert/search'); ?>">

											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Quality Certificate No</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="qc_no" name="qc_no">
												</div>
											</div>

											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Quality Certificate Date</label>
												<div class="col-md-2">
													<input type="date" class="form-control" id="qc_date_start" name="qc_date_start">
												</div>
												<label class="col-md-1 control-label" for="inputDefault">To</label>
												<div class="col-md-2">
													<input type="date" class="form-control" id="qc_date_end" name="qc_date_end">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<select id="basic" data-plugin-selectTwo class="form-control" id="qc_customer" name="qc_customer">
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<select id="basic" data-plugin-selectTwo class="form-control" id="country" name="country">
															<option value="">-- Pilih --</option>
...
<?php
if(!empty($lsmaster_qcert)){
  // Jika data pada database tidak sama dengan empty (alias ada datanya)
$no_urut=1;
  foreach($lsmaster_qcert as $gaa){
    echo "<tr>";
	echo "<th scope='row'>".$no_urut++."</th>";
	echo "<td>".$gaa->gexp_qs_date."</td>";
	echo "<td>".$gaa->gexp_qs_no."</td>";
	echo "<td>".$gaa->gexp_invoice_no."</td>";
	// echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("MenuQCert/viewlist_prodspec_detail/".$gaa->gexp_qs_id)."'><i class='fa fa-file'></i></a></td>";
	echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("MenuQCert/qs_print_byrow/".$gaa->gexp_qs_id)."'><i class='fa fa-print'></i></a></td>";
