  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-success">
        ...
        <h5 class="modal-title" id="exampleModalLabel">Create Master User</h5>
	  ...
	  <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('MasterUser/createnewuser');?>" id="inputdatagroup" method="POST">
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="jabatan" data-plugin-maxlength maxlength="255" />
													<!-- <p>
														<code>max-length</code> set to 50 character.
													</p> -->
												</div>
