            ...
            <section class="body">
                ...
                <div class="inner-wrapper">
                    ...
                    <section role="main" class="content-body">
                        ...
                        <a class="btn btn-warning" href="<?=base_url('UserImport')?>">
                            <i class="fa fa-arrow-left"></i> Back
                        </a>

                        <!-- Start Content -->
                        <div class="panel panel-default" style="margin-top: 20px;">
                            <div class="panel-heading"><h5>Form Edit User</h5></div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="accname" name="accname" placeholder="Enter account name" value="<?=$data->user_accountname?>" style="text-transform: capitalize;" oninput="this.value = this.value.replace(/[^A-Za-z. ]/g, '').replace(/(\..*?)\..*/g, '$1');" required>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="username" name="username" placeholder="Enter username" value="<?=$data->user_username?>" style="text-transform: lowercase;" oninput="this.value = this.value.replace(/[^a-z.]/g, '').replace(/(\..*?)\..*/g, '$1');" required>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="nip" name="nip" placeholder="Enter NIP" value="<?=$data->user_nip?>" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*?)\..*/g, '$1');" required>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" class="form-control" id="email" name="email" placeholder="Enter email" value="<?=$data->user_email?>" required>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="phonenumber" name="phonenumber" placeholder="Enter phone number" value="<?=$data->user_phone?>" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*?)\..*/g, '$1');" required>
        ...
        <script>
            $(document).ready(function() {
               ...
               $('#form-edit-user').submit(function (event) {
                    ...
                    if ($('#form-edit-user')[0].checkValidity() === false) {
                        event.stopPropagation();
                    } else {
                        console.log('Test');
                        $.ajax({
                           url : "<?php echo base_url('UserImport/update') ?>",
                            type: "POST",
