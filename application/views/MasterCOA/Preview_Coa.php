...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Dashboard COA : Preview COA Details</h5>
							</header>
							<div class="panel-body">

<div class="container-fluid">

	<a class="btn btn-warning" href="<?php echo base_url('MenuCOA/detailmap_coa/'.$getrowdetails_coa->detail_coa_head); ?>"><i class="fa  fa-arrow-left"></i> Back</a>
	<a class="btn btn-danger" href="<?php echo base_url('MenuCOA/print_details_coa/'.$getrowdetails_coa->detail_coa_id); ?>"><i class="fa fa-print"></i> Print</a>
							...
							<form class="form-horizontal form-bordered" method="get">
											...
											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">COA Numbers</label>
												<div class="col-md-3">
													<input type="text" value="<?php echo $getrowdetails_coa->gexp_coa_no ?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>

											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Batch Numbers</label>
												<div class="col-md-3">
													<input type="text" class="form-control" value="<?php echo $getrowdetails_coa->detail_coa_batch ?>" id="inputDefault" disabled>
												</div>
											</div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-2">
													<input type="date" value="<?php echo $getrowdetails_coa->gexp_qc_production_date ?>" class="form-control" id="inputDefault" disabled>
												</div>
												<label class="col-md-1 control-label" for="inputDefault">Expired Date</label>
												<div class="col-md-2">
													<input type="date" value="<?php echo $getrowdetails_coa->gexp_qc_expired_date ?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
												<input type="text" class="form-control" value="<?php echo $getrowdetails_coa->gexp_qc_aroma ?>" id="input_Aroma" name="input_Aroma" placeholder="Enter ..." required readonly>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
												<input type="text" class="form-control" value="<?php echo $getrowdetails_coa->gexp_qc_taste ?>" id="input_Taste" name="input_Taste" placeholder="Enter ..." required readonly>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
												<input type="text" class="form-control" value="<?php echo $getrowdetails_coa->gexp_qc_moisture ?>" id="input_Moisture" name="input_Moisture" placeholder="Enter ..." required readonly>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
												<input type="text" class="form-control" value="<?php echo $getrowdetails_coa->gexp_qc_ph ?>" id="input_Ph" name="input_Ph" placeholder="Enter ..." required readonly>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
												<input type="text" class="form-control" value="<?php echo $getrowdetails_coa->gexp_qc_brix ?>" id="input_Brix" name="input_Brix" placeholder="Enter ..." required readonly>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" value="<?php echo $getrowdetails_coa->Mercury ?>" id="input_Mercury" name="input_Mercury" placeholder="Enter ..." required>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" value="<?php echo $getrowdetails_coa->Lead ?>" id="input_Lead" name="input_Lead" placeholder="Enter ..." required>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" value="<?php echo $getrowdetails_coa->Cadmium ?>" id="input_Cadmium" name="input_Cadmium" placeholder="Enter ..." required>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" value="<?php echo $getrowdetails_coa->Tin ?>" id="input_Tin" name="input_Tin" placeholder="Enter ..." required>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" value="<?php echo $getrowdetails_coa->Arsenic ?>" id="input_Arsenic" name="input_Arsenic" placeholder="Enter ..." required>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
												<input type="text" class="form-control" value="<?php echo $getrowdetails_coa->gexp_qc_salmonella ?>" id="input_Salmonella" name="input_Salmonella" placeholder="Enter ..." required readonly>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
												<input type="text" class="form-control" value="<?php echo $getrowdetails_coa->gexp_qc_total_plate_count ?>" id="input_Expdate" name="input_Expdate" placeholder="Enter ..." required readonly>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
												<input type="text" class="form-control" value="<?php echo $getrowdetails_coa->gexp_qc_yeast_mold ?>" id="input_MoldYeast" name="input_MoldYeast" placeholder="Enter ..." required readonly>
