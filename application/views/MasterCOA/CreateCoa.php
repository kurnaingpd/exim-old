...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Dashboard COA : Create COA</h5>
							</header>
...
<a class="btn btn-warning" href="<?php echo base_url('MenuCOA/'); ?>"><i class="fa fa-arrow-left"></i> Back</a>
							...
							<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('MenuCOA/savecoa_no'); ?>">

											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">COA No</label>
												<div class="col-md-3">
													<input type="text" value="<?php echo $noticket."/".$m."/".$y."/"; ?>" class="form-control" name="no_coa" readonly>
													<code style="font-size: 8;">* Automatic</code>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<select id="basic" class="form-control" name="no_invoice" required>
															<option value="">-- Pilih --</option>
														<?php foreach($lsinvoice_notselect as $dt) : ?>
											...
											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Date </label>
												<div class="col-md-3">
													<input type="date" class="form-control" value="<?php echo Tanggal ?>" name="date_coa" id="inputDefault" disabled>
											...
											<div class="form-group">
												...
												<div class="col-md-2">
													<button type="submit" class="btn btn-block btn-primary"><i class="fa fa-save"></i> Create</button>
												</div>
											</div>
