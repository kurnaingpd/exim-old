...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Dashboard COA : COA</h5>
							</header>
							<div class="panel-body">

<div class="container-fluid">

<a class="btn btn-success" href="<?php echo base_url('MenuCOA/create_coa'); ?>"><i class="fa fa-file"></i> New</a>

</div>

							<hr>

							<form class="form-horizontal form-bordered" method="post" action="<?php echo base_url('MenuCOA/search'); ?>">

											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">COA Numbers</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="coa_numbers" name="coa_numbers">
												</div>
											</div>

											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">COA Date</label>
												<div class="col-md-2">
											...
											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Invoice</label>
												<div class="col-md-3">
													<select id="basic" data-plugin-selectTwo class="form-control" id="invoice" name="invoice">
											...
											<!-- <div class="form-group">
												...
												<div class="col-md-3">
													<select id="basic" data-plugin-selectTwo class="form-control" id="product" name="product">
															<option value="">-- Pilih --</option>
...
$no_urut=1;
  foreach($lsmastercoa as $gaa){
    ...
    echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("MenuCOA/detailmap_coa/".$gaa->gexp_coa_id)."'><i class='fa fa-pencil-square-o'></i></a></td>";
    echo "</tr>";
  }
