...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Master Syst : Master Icons</h5>
							</header>
...
<div id="modalAnim" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
    <section class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('MasterIcon/createnewicon');?>" id="inputdatagroup" method="POST">
								

											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Icons Desc</label>
												<div class="col-md-8">
													<input class="form-control" name="iconsdesc" data-plugin-maxlength maxlength="50" />
													<p>
														<code>Create New Icons</code>.
													</p>
												</div>
                                            </div>
...
<!-- End Modal Insert Group -->
								...
								<table class="table table-bordered table-striped mb-none" id="tables3">
									...
									<?php
if(!empty($lsmastericons)){
  // Jika data pada database tidak sama dengan empty (alias ada datanya)
$no_urut=1;
  foreach($lsmastericons as $gaa){
    echo "<tr>";
	echo "<th scope='row'>".$no_urut++."</th>";
	echo "<td>".$gaa->IconsDesc."</td>";
	// echo "<td>".$gaa->IconsStats."</td>";
	...
	echo "<td><i class='".$gaa->IconsDesc."'></i></td>";
