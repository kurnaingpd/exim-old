    ...
    <section class="panel panel-warning">
        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('MasterUser/submiteditmasterusers');?>" id="inputdatagroup" method="POST">
                                ...
                                <input type="hidden" name="usersid" value="<?php echo $lsmasterusers[0]->UsersId ?>">
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="userpassword" value="<?php echo $lsmasterusers[0]->UserPassword ?>" data-plugin-maxlength maxlength="50" disabled/>
													<!-- <p>
														<code>max-length</code> set to 50 character <code>lowercase</code>.
													</p> -->
												</div>
