...
<a class="btn btn-success" href="<?php echo base_url('MenuProSpec/create_master_prodspec');?>"><i class="fa fa-file"></i> New</a>

</div>

							<hr>

							<form class="form-horizontal form-bordered" method="post" action="<?php echo base_url('MenuProSpec/search');?>">

											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Product Specification No</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="prod_spec_no" name="prod_spec_no">
												</div>
											</div>

											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Product Specification Date</label>
												<div class="col-md-2">
													<input type="date" class="form-control" id="prod_spec_start" name="prod_spec_start">
												</div>
												<label class="col-md-1 control-label" for="inputDefault">To</label>
												<div class="col-md-2">
													<input type="date" class="form-control" id="prod_spec_end" name="prod_spec_end">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<select id="basic" data-plugin-selectTwo class="form-control" id="customer" name="customer">
...
$no_urut=1;
  foreach($lsmasterprospec as $gaa){
	...
	echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("MenuProSpec/viewlist_prodspec_detail/".$gaa->gexp_spec_id)."'><i class='fa fa-pencil-square-o'></i></a></td>";
