...
<a class="btn btn-warning" href="<?php echo base_url('MenuProSpec/');?>"><i class="fa fa-left-arrow"></i> Back</a>

</div>

							<hr>

							<form method="POST" action="<?php echo base_url('MenuProSpec/save_master_prodspec');?>">

											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Product Specification No</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="prdspec_no" value="<?php echo $noticket."/SKP-PRDSPEC/".$m."/".$y.""; ?>" id="prdspec_no" required>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="date" value="<?php echo $datenow; ?>" name="prdspec_date" class="form-control" id="prdspec_date" required>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<select id="basic" data-plugin-selectTwo class="form-control" id="inv_no" name="inv_no" required>
											...
											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">PO No</label>
												<div class="col-md-3">
											...
											<div class="form-group">
												...
												<div class="col-md-2">
													<button type="submit" class="btn btn-block btn-primary"><i class="fa fa-plus-circle"></i> Add New</button>
												</div>
											</div>
