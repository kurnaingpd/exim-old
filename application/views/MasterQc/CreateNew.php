...
<div class="container-fluid">
	...
	<a class="btn btn-warning" href="<?php echo base_url('MasterQc');?>"><i class="fa fa-arrow-left"></i> Back</a>
				...
				<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('MasterQc/InsertCreateNew');?>" enctype="multipart/form-data">

						<div class="container">
							<h4 style="font-weight: bolder;">Create QC Check</h4>
						</div>

                            <hr>

											<div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">Qc No</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="qc_number" value="<?php echo $noticket."/SKP-QC/".$m."/".$y; ?>" id="inputDefault" readonly>
												</div>
											</div>
											
											<div class="form-group">
                                                <label class="col-md-2 control-label" for="inputDefault">Qc Date</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="qc_date" value="<?php echo $datenow ?>" id="inputDefault" readonly>
												</div>
                                                <!-- <label class="col-md-1 control-label" for="inputDefault">FFRN #</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="pi_po" placeholder="Free Text" id="inputDefault">
												</div> -->
											</div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-4">
													<select class="form-control" name="qc_item_id" id="input_customer_id" required>
															<option value="">-- Pilih --</option>
														<?php foreach($listDataItem as $dt) : ?>
															<option value="<?php echo $dt->ItemId;?>"><?php echo $dt->ItemName;?></option>
														<?php endforeach; ?>
                                                    </select>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="date" class="form-control" name="prd_date" id="inputDefault" required>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="date" class="form-control" name="exp_date" id="inputDefault" required>
												</div>
                                                <!-- <label class="col-md-1 control-label" for="inputDefault">FFRN #</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="pi_po" placeholder="Free Text" id="inputDefault">
											...
											<div class="form-group">
												<label class="col-md-10" style="font-weight: bold;" for="inputDefault">ORGANOLETIC, PHYSICAL, CHEMICAL TEST</label>
												<div class="col-md-2">
													<!-- <input type="date" class="form-control" name="prd_date" id="inputDefault"> -->
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" name="aroma" id="inputDefault" required>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" name="value" id="inputDefault" required>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" name="ph" id="inputDefault" required>
												</div>
											</div>
											<div class="form-group">
                                                <label class="col-md-2 control-label" for="inputDefault">Brix</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="brix" id="inputDefault" required>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="date" class="form-control" name="finish_godcek" id="inputDefault" required>
												</div>
											</div>

											<div class="form-group">
												<label class="col-md-10" style="font-weight: bold;" for="inputDefault">Microbiology</label>
												<div class="col-md-2">
													<!-- <input type="date" class="form-control" name="prd_date" id="inputDefault"> -->
												</div>
											</div>
											...
											<div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">Analisis Date</label>
												<div class="col-md-3">
													<input type="date" class="form-control" name="analisis_start" id="inputDefault" required>
												</div>
											</div>
											<div class="form-group">
                                                <label class="col-md-2 control-label" for="inputDefault">Analisis End Date</label>
												<div class="col-md-3">
													<input type="date" class="form-control" name="analisis_end" id="inputDefault" required>
												</div>
                                                <!-- <label class="col-md-1 control-label" for="inputDefault">FFRN #</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="pi_po" placeholder="Free Text" id="inputDefault">
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" name="plate_count" id="inputDefault" required>
												</div>
											</div>
											<div class="form-group">
                                                <label class="col-md-2 control-label" for="inputDefault">Yeast & Mold</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="yeasmold" id="inputDefault" required>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">Salmonella</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="salmonella" id="inputDefault" required>
												</div>
											</div>
											<div class="form-group">
                                                <label class="col-md-2 control-label" for="inputDefault">Enterobacteriaceae</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="enterobacteria" id="inputDefault" required>
												</div>
											</div>
											...
											<!-- <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" name="status_text" id="inputDefault">
												</div>
											</div> -->
											...
											<div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">Status</label>
												<div class="col-md-3">
													<select name="status_text" class="form-control" required>
											...
											<div class="form-group">
                                                <label class="col-md-2 control-label" for="inputDefault">Release QC</label>
												<div class="col-md-3">
													<input type="date" class="form-control" name="release_qcdate" id="inputDefault" required>
												</div>
                                                <!-- <label class="col-md-1 control-label" for="inputDefault">FFRN #</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="pi_po" placeholder="Free Text" id="inputDefault">
											...
											<!-- <div class="form-group">
												<label class="col-md-10" style="font-weight: bold;" for="inputDefault">Lampiran</label>
												<div class="col-md-2">
													<input type="date" class="form-control" name="prd_date" id="inputDefault">
												</div>
											</div>
											...
											<div class="form-group">
                                                <label class="col-md-2 control-label" for="inputDefault">Country 1</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="ctx1" id="inputDefault">
												</div>
                                                <label class="col-md-1 control-label"  for="inputDefault">File 1</label>
												<div class="col-md-3">
													<input type="file" class="form-control" name="brx1 placeholder="Free Text" id="inputDefault">
												</div>
											</div>

											<div class="form-group">
                                                <label class="col-md-2 control-label" for="inputDefault">Country 2</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="ctx2" id="inputDefault">
												</div>
                                                <label class="col-md-1 control-label" for="inputDefault">File 2</label>
												<div class="col-md-3">
													<input type="file" class="form-control" name="brx2" placeholder="Free Text" id="inputDefault">
												</div>
											</div>

											<div class="form-group">
                                                <label class="col-md-2 control-label" for="inputDefault">Country 3</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="ctx3" id="inputDefault">
												</div>
                                                <label class="col-md-1 control-label" for="inputDefault">File 3</label>
												<div class="col-md-3">
													<input type="file" class="form-control" name="brx3" placeholder="Free Text" id="inputDefault">
												</div>
											</div> -->

											<!-- <div class="form-group">
                                                <label class="col-md-2 control-label" for="inputDefault">Country 4</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="release_qcdate" id="inputDefault">
												</div>
                                                <label class="col-md-1 control-label" for="inputDefault">File 4</label>
												<div class="col-md-3">
													<input type="file" class="form-control" name="pi_po" placeholder="Free Text" id="inputDefault">
												</div>
											</div> -->
...
<!-- 
											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Country 01</label>
												<div class="col-md-3">
											...
											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Country 02</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault">
												</div>
                                                <label class="col-md-1 control-label" for="inputDefault"></label>
											...
											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Country 03</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault">
												</div>
                                                <label class="col-md-1 control-label" for="inputDefault"></label>
											...
											<!-- <div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Country 04</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault">
												</div>
                                                <label class="col-md-1 control-label" for="inputDefault"></label>
											...
											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Country 05</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault">
												</div>
                                                <label class="col-md-1 control-label" for="inputDefault"></label>
