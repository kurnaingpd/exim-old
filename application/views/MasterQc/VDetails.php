...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Dashboard QC : Details QC Check </h5>
							</header>
							<div class="panel-body">

							<a class="btn btn-warning" href="<?php echo base_url('MasterQc');?>"><i class="fa fa-arrow-left"></i> Back</a>
							<!-- <a class="btn btn-info" onclick="alert('test print');"><i class="fa fa-print"></i> Print</a> -->
...
<div class="container-fluid">
							<form class="form-horizontal form-bordered" method="get">
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" value="<?php echo $details_qc->ItemName ?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="date" value="<?php echo $details_qc->gexp_qc_production_date ?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" value="<?php echo $details_qc->gexp_qc_aroma ?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" value="<?php echo $details_qc->gexp_qc_taste ?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" value="<?php echo $details_qc->gexp_qc_value?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" value="<?php echo $details_qc->gexp_qc_moisture ?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" value="<?php echo $details_qc->gexp_qc_ph?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" value="<?php echo $details_qc->gexp_qc_brix?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" value="<?php echo $details_qc->gexp_qc_finish_goodcheck?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" value="<?php echo $details_qc->gexp_qc_start_analysis?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" value="<?php echo $details_qc->gexp_qc_end_analysis?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" value="<?php echo $details_qc->gexp_qc_total_plate_count ?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" value="<?php echo $details_qc->gexp_qc_yeast_mold?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" value="<?php echo $details_qc->gexp_qc_salmonella ?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" value="<?php echo $details_qc->gexp_qc_enterobacteria ?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" value="<?php if($details_qc->gexp_qc_status=='1'){
														echo "Aman";
													}else{
														echo "Tidak Aman";
													}?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="date" value="<?php echo $details_qc->gexp_qc_release_date?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>
