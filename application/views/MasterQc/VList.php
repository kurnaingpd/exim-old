...
<div class="container-fluid">
	...
	<a class="btn btn-success" href="<?php echo base_url('MasterQc/CreateNew');?>"><i class="fa fa-file"></i> New</a>

</div>

							<hr>

							<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('MasterQc/Searchdata') ?>">

											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Product Name</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="produk">
												</div>
											</div>

											<!-- <div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Batch Nummber</label>
												<div class="col-md-3">
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="date" class="form-control" id="inputDefault" name="prd_date">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="date" class="form-control" id="inputDefault" name="exp_date">
												</div>
											</div>
...
$no_urut=1;
  foreach($lsmasterqc as $gaa){
	...
	// 	}
	// echo"</td>";
	// echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("MasterQc/TambahFileLamp/".$gaa->gexp_qc_id)."'><i class='fa fa-file'></i></a></td>";
