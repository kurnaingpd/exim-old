...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5 style="color:white;">Master Syst : Master Menu Set</h5>
							</header>
							<div class="panel-body">

<!-- <a style="margin-bottom: 25px;" class="mb-md mt-xs mr-xs modal-with-move-anim btn btn-success" href="#modalAnim">New</a> -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-success">
        ...
        <h5 class="modal-title" id="exampleModalLabel">Create Master Menus</h5>
        
      </div>
      <div class="modal-body">
	  <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('MasterMenu/createnewmenu');?>" id="inputdatagroup" method="POST">
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Menu Name</label>
												<div class="col-md-8">
													<input class="form-control" name="menusname" data-plugin-maxlength maxlength="50" />
													<p>
											...
											<div class="form-group">
												<label class="col-md-3 control-label">Menu Icons</label>
												<div class="col-md-8">
                                                    
                                                    <select id="basic" data-plugin-selectTwo class="form-control" name="menusicon">
													<option value="">-- Pilih --</option>
														<?php foreach($iconlisting as $dt) : ?>
															<option value="<?php echo $dt->IconsId;?>"><?php echo "<i class='$dt->IconsDesc' aria-hidden='true'></i>".$dt->IconsDesc ?></option>
														<?php endforeach; ?>
                                                    </select>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Menu Link</label>
												<div class="col-md-8">
													<input class="form-control" name="menuslink" data-plugin-maxlength maxlength="50" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
                                                    ...
                                                    <select id="basic" data-plugin-selectTwo class="form-control" name="menuparents">
													<option value="">-- Pilih --</option>
													<option value="0">Header - (Single Menu)</option>
														<?php foreach($menulisting as $dt) : ?>
															<option value="<?php echo $dt->MenusId;?>"><?php echo $dt->MenusName; ?></option>
														<?php endforeach; ?>
                                                    </select>
