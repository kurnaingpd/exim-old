...
<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('DocImport/get_filter_search'); ?>">
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="po" value="<?php if($po!=""){
														echo $po;
													}else{
														echo "";
													} ?>">
											...
											<div class="form-group">
												...
												<div class="col-md-2">
													<input type="date" class="form-control" id="inputDefault" name="start_deliv" value="<?php if($start_deliv!=""){
														echo $start_deliv;
													}else{
														echo "";
													} ?>">
												...
												<div class="col-md-2">
													<input type="date" class="form-control" id="inputDefault" name="end_deliv" value="<?php if($end_deliv!=""){
														echo $end_deliv;
													}else{
														echo "";
													} ?>">
												...
												<div class="col-md-3">
													<select id="basic" data-plugin-selectTwo class="form-control" name="consig">
															<option value="<?php if($consig=='1'){
																		...
																		echo "Selected : GDA ( Global Dairy Alami )";
																	}elseif($consig=='2'){
																		echo "Selected :  PTB ( Prima Top Boga )";
																	}elseif($consig=='3'){
																		echo "Selected :  SKP ( Sumber Kopi Prima )";
																	}else{
																		echo "-- All --";
																	}; ?></option>
															<option value=""> 
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<select id="basic" data-plugin-selectTwo class="form-control" name="pengirim">
															<option value="<?php if($pengirim!=""){
																echo $pengirim;
															}else{
																echo "";
															} ?>"> <?php if($pengirim!=""){
																echo "Selected : $pengirim";
															}else{
																echo "-- All --";
															} ?> </option>
															<option value=""> 
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<select id="basic" data-plugin-selectTwo class="form-control" name="forwarder">
															<option 
															value="<?php if($forwarder!=""){
																echo "Selected : $forwarder";
															}else{
																echo "";
															} ?>"> <?php if($forwarder!=""){
																echo $forwarder;
...
<form action="<?php echo base_url('DocImport/export_excel_docim_bysearch'); ?>" method="POST">
	<input type="hidden" value="<?php echo $po ?>" name="po">
	<input type="hidden" value="<?php echo $start_deliv ?>" name="start_deliv">
	<input type="hidden" value="<?php echo $end_deliv ?>" name="end_deliv">
	<input type="hidden" value="<?php echo $consig ?>" name="consig">
	<input type="hidden" value="<?php echo $category ?>" name="category">
	<input type="hidden" value="<?php echo $pengirim ?>" name="pengirim">
	<input type="hidden" value="<?php echo $forwarder ?>" name="forwarder">
	<button type="submit" class="btn btn-success"><i class="fa fa-table"></i> Excel</button>
</form>
	
	<!-- <a class="btn btn-success" href="<?php echo base_url('DocImport/export_excel_docim_bysearch'); ?>"><i class="fa fa-table"></i> EXCEL</a> -->
</div>
<br>
...
<tr>
												...
												<div class="panel-body">
													<div class="modal-wrapper">
														...
														<form action="<?php echo base_url('DocImport/submit_delete_data'); ?>" method="POST">
															...
															<strong><p><?php echo $gaa->docim_id; ?>, <?php echo $gaa->docim_po; ?></p></strong>
														</div>
													</div>
												</div>
												<footer class="panel-footer">
										...
										<td><?php echo number_format("$gaa->docim_handling",0,",","."); ?></td>
										...
										<td><?php echo number_format("$gaa->docim_cif2",0,",","."); ?></td>
