...
<br>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<select id="basic" data-plugin-selectTwo class="form-control" name="consignee">
														...
														<?php foreach($ls_master_consignee as $data) : ?>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="gw">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="nw">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="D" name="currency">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="E" name="cif">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="F" name="duty">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="G" name="freight">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="H" name="handling">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="I" name="atcost">
												</div>
                                            </div>
