...
<div class="row">
<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('DocImport/submit_tambah_data'); ?>">

<a class="mb-xs mt-xs mr-xs btn btn-warning" style="width:150px;" href="<?php echo base_url('DocImport/'); ?>"><i class="fa fa-arrow-left"></i> Back</a>

<a class="mb-xs mt-xs mr-xs btn btn-danger" style="width:150px;" href="<?php echo base_url('DocImport/tambah_data'); ?>"><i class="fa fa-recycle"></i> Reset</a>

<button type="submit" class="mb-xs mt-xs mr-xs btn btn-primary" style="width:150px;"><i class="fa fa-save"></i> Simpan</button>
...
<br>
											...
											<div class="form-group">
												...
												<label style="font-weight: 600; color:black; border-style:solid; border-color:#172774; padding:10px; border-width:0.5px; background-color:white; font-size:16px;" class="col-md-12" for="inputDefault">Tambah Document Import</label>
												<!-- <div class="col-md-3">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="shipnum">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="pengirim">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="penjual">
												</div>
											</div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="comodity">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="hs_code">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="lartas">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="hbl">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="mbl">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="qty_container">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="container_num">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="number" class="form-control" id="inputDefault" name="good_qty">
												</div>
												<label class="col-md-1" for="inputDefault">Master UOM</label>
												<div class="col-md-3">
													<!-- <input type="number" class="form-control" id="inputDefault" name="good_qty"> -->
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="number" class="form-control" id="inputDefault" name="gw">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="number" class="form-control" id="inputDefault" name="nw">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="number" class="form-control" id="inputDefault" name="cbm">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="pol">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="pod">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="date" class="form-control" id="inputDefault" name="etd">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="pib_aju">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="coo">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="masterlist">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="date" class="form-control" id="inputDefault" name="rcvd">
												</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-md-1" for="inputDefault">Billing</label>
												<div class="col-md-3">
													<input type="date" class="form-control" id="inputDefault" name="billing">
												</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-md-1" for="inputDefault">SPJM</label>
												<div class="col-md-3">
													<input type="date" class="form-control" id="inputDefault" name="spjm">
												</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-md-1" for="inputDefault">SPJK</label>
												<div class="col-md-3">
													<input type="date" class="form-control" id="inputDefault" name="spjk">
												</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-md-1" for="inputDefault">SPPB</label>
												<div class="col-md-3">
													<input type="date" class="form-control" id="inputDefault" name="sppb">
												</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-md-1" for="inputDefault">Pickup DO</label>
												<div class="col-md-3">
													<input type="date" class="form-control" id="inputDefault" name="pickup_do">
												</div>
                                            </div>
                                            <div class="form-group">
												...
												<div class="col-md-3">
													...
													<small>Jika Lead Time Belum muncul/ belum sesuai, harap klik / pilih kembali delivery date.</small>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="remarks">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="D" name="currency" required>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="E" name="cif" required>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="F" name="duty" required>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="vat">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="tax">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="G" name="freight" required>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="H" name="handling" required>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="I" name="atcost" required>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="number" class="form-control" id="J" name="additional">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="leadtime" name="lead_time" readonly>
												</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-md-1" for="inputDefault">Time</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="time">
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="M" name="percent1" readonly>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="N" name="cif_2" readonly>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="O" name="landed_cost" readonly>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												<label class="col-md-1" for="inputDefault">%</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="P" name="percent2" readonly>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="forwarder">
												</div>
                                            </div>
