...
<a class="btn btn-warning" href="<?php echo base_url('MenuCheckDocexp');?>">Back</a>

</div>

							<hr>

							<form class="form-horizontal form-bordered" action="<?php echo base_url('MenuCheckDocexp/SearchListView');?>" method="POST">

											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">PI Number</label>
												<div class="col-md-3">
													<input type="text" name="pi_number" class="form-control" id="inputDefault">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-2">
													<input type="date" name="date_a" class="form-control" id="inputDefault">
												</div>
												<label class="col-md-1 control-label" for="inputDefault">To</label>
												<div class="col-md-2">
													<input type="date" name="date_b" class="form-control" id="inputDefault">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" name="pi_customer" class="form-control" id="inputDefault">
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" name="pi_country" class="form-control" id="inputDefault">
													<!-- <select id="basic" data-plugin-selectTwo class="form-control" name="customercountry">
															<option value="">-- Pilih --</option> -->
														<!-- <?php foreach($lsmastercountry as $dt) : ?>
															<option value="<?php echo $dt->CountryId;?>">(<?php echo $dt->CountryCode;?>) <?php echo $dt->CountryName;?></option>
								...
								<table class="table table-bordered table-striped mb-none" id="tables3">
									<thead>
										<tr>
                                            ...
                                            <th class="hidden-phone">Status PI</th>
											<th class="hidden-phone">Status Upload ExpReq</th>
                                            <th class="hidden-phone">Upload Doc</th>
											<th class="hidden-phone">Download Doc01</th>
											<th class="hidden-phone">Download Doc02</th>
											<th class="hidden-phone">Revisi Noted</th>
											<th class="hidden-phone">Revisi Time</th>
										</tr>
									</thead>
									<tbody>
<?php
if(!empty($ls_filter_data)){
  // Jika data pada database tidak sama dengan empty (alias ada datanya)
$no_urut=1;
  foreach($ls_filter_data as $gaa){
    echo "<tr>";
	...
	// echo "<td><span class='label label-success'>";
		...
		if($gaa->gexp_expreq_statusDoc=='3'){
			echo "<td>-</td>";
		}elseif($gaa->gexp_expreq_statusDoc=='4'){
			echo "<td><a style='font-size:18px;' href='".base_url("MenuCheckDocexp/upload_expreq/".$gaa->gexp_expreq_id)."' class='btn small-btn-ic-info shadow-sm' id='anim' href='#'><i class='fa fa-upload'></i></a></td>";
		}elseif($gaa->gexp_expreq_statusDoc=='5'){
			echo "<td><a style='font-size:18px;' href='".base_url("MenuCheckDocexp/upload_expreq/".$gaa->gexp_expreq_id)."' class='btn small-btn-ic-info shadow-sm' id='anim' href='#'><i class='fa fa-upload'></i></a></td>";
		}else{
			echo "<td>-</td>";
		}
		...
		if($gaa->gexp_expreq_docval==1){
			echo "<td><a style='font-size:18px;' href='".base_url("MenuCheckDocexp/download_expreq/".$gaa->gexp_expreq_id)."' class='btn small-btn-ic-info shadow-sm' id='anim' href='#'><i class='fa fa-download'></i></a></td>";
		}else{
			echo "<td>-</td>";
		}
    ...
    // if($gaa->gexp_pi_isApproved=='1'){
	// 	echo "<td>-</td>";
	// }else{
	// 	echo "<td><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' id='anim' href='".base_url("MenuApprovalPI/ApprovedPI_byid/".$gaa->gexp_pi_id)."'><i class='fa fa-check-circle-o'></i></a> <a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' id='anim' href='".base_url("MenuApprovalPI/VoidPI_byid/".$gaa->gexp_pi_id)."'><i class='fa fa-times'></i></a></td>";
	// 	// echo "<td><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' id='anim' href='#'><i class='fa fa-times'></i></a></td>";
    // }
	...
	// 	echo "<td>-</td>";
	// }else{
		// echo "<td><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' id='anim' href='#'><i class='fa fa-check-circle-o'></i></a></td>";
	// }
