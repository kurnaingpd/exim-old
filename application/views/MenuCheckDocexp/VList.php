								...
								<table class="table table-bordered table-striped mb-none" id="tables3">
									<thead>
										<tr>
											...
											<th class="hidden-phone">Preview PI</th>
											<th class="hidden-phone">Status PI</th>
											<th class="hidden-phone">Status Upload ExpReq</th>
											<th class="hidden-phone">Upload Doc</th>
											<th class="hidden-phone">Download Doc 01</th>
											<th class="hidden-phone">Download Doc 02</th>
									...
									<tbody>
										...
										$no_urut=1;
										  foreach($listdataPI as $gaa){
											...
											echo "<td><a style='font-size:18px;' href='".base_url("MenuCheckDocexp/preview_pi/".$gaa->gexp_expreq_pi_id)."' class='btn small-btn-ic-info shadow-sm' id='anim' href='#'><i class='fa fa-file-text-o'></i></a></td>";
