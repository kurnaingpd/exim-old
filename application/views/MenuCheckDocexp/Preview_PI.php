...
<header class="page-header" style="background-color: #172774;">
	<h2>Check Export Requirement</h2>				
...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Check Export Requirement : Preview Proforma Invoice</h5>
							</header>
...
<!-- <a class="btn btn-success" href="<?php echo base_url('MasterBoardPI/CreateNew');?>"><i class="fa fa-file"></i> New</a> -->
        ...
        <a class="btn btn-primary" href="<?php echo base_url('MenuCheckDocexp/');?>"><i class="fa fa-arrow-left"></i> Back</a>
        <!-- <div class="col-lg-2"> -->
    <!-- <?php if($getrowpi_byid[0]->gexp_pi_statusPI=='3' OR $getrowpi_byid[0]->gexp_pi_statusPI=='4' OR $getrowpi_byid[0]->gexp_pi_statusPI=='5'){ ?>
        <a class="btn btn-success" href="<?php echo base_url('MasterBoardPI/submitPI_byid/'.$getrowpi_byid[0]->gexp_pi_id);?>"><i class="fa fa-check-circle-o"></i> Submit</a>
    <?php } ?> -->
        <!-- </div> -->
        <a class="btn btn-danger" href="<?php echo base_url('CetakPI/printout_PI/'.$getrowpi_byid[0]->gexp_pi_id);?>"><i class="fa fa-print"></i> Print</a>
    

</div>
<hr>

<?php if($getrowpi_byid[0]->gexp_pi_statusPI=='5'){ ?>
<br>
<div class="row">
    ...
    <div class="col-lg-6">
        <textarea class="form-control" rows="3" data-plugin-maxlength maxlength="355" readonly></textarea>
    </div>
...
<div class="row">
    ...
    <div class="col-lg-5">
        ...
        <?php }elseif($getrowpi_byid[0]->gexp_pi_statusPI=='3'){?>
            <input style="background-color: #FF7F3F; font-weight:bold;" type="text" value="On Progress" class="form-control" readonly>
        <?php }elseif($getrowpi_byid[0]->gexp_pi_statusPI=='5'){?>
            <input style="background-color: #FFC900; font-weight:bold;" type="text" value="Revised" class="form-control" readonly>
        <?php }elseif($getrowpi_byid[0]->gexp_pi_statusPI=='2'){?>
            <input style="background-color: #F05454; font-weight:bold;" type="text" value="Void" class="form-control" readonly>
...
<div class="row">
    ...
    <div class="col-lg-5">
        <input type="text" value="<?php echo $getrowpi_byid[0]->gexp_pi_no; ?>" class="form-control" > 
    </div>
...
<div class="row">
    ...
    <div class="col-lg-5">
        <input type="text" value="<?php echo $getrowpi_byid[0]->gexp_pi_date; ?>" class="form-control" > 
    </div>
...
<div class="row">
    ...
    <div class="col-lg-5">
        <input type="text" value="<?php echo $getrowpi_byid[0]->gexp_pi_po; ?>" class="form-control" > 
    </div>
...
<div class="row">
    ...
    <div class="col-lg-5">
        <input type="text" value="<?php echo $getrowpi_byid[0]->Consig; ?>" class="form-control" > 
    </div>
...
<div class="row">
    ...
    <div class="col-lg-5">
        <textarea class="form-control" rows="4" data-plugin-maxlength maxlength="255" value="<?php echo $getrowpi_byid[0]->Cons_addr;?>"><?php echo $getrowpi_byid[0]->Cons_addr;?></textarea>
        <!-- <input type="text" value="<?php echo $getrowpi_byid[0]->Cons_addr; ?>" class="form-control" >  -->
    </div>
...
<div class="row">
    ...
    <div class="col-lg-5">
        <input type="text" value="<?php echo $getrowpi_byid[0]->Cons_country; ?>" class="form-control" > 
    </div>
...
<div class="row">
    ...
    <div class="col-lg-5">
        <input type="text" value="<?php echo $getrowpi_byid[0]->Cons_phone; ?>" class="form-control" > 
    </div>
...
<div class="row">
    ...
    <div class="col-lg-5">
        <input type="text" value="<?php echo $getrowpi_byid[0]->Benefi; ?>" class="form-control" > 
    </div>
...
<div class="row">
    ...
    <div class="col-lg-5">
    <textarea class="form-control" rows="4" data-plugin-maxlength maxlength="255" value="<?php echo $getrowpi_byid[0]->Bene_addr;?>"><?php echo $getrowpi_byid[0]->Bene_addr;?></textarea>
        <!-- <input type="text" value="<?php echo $getrowpi_byid[0]->Bene_addr; ?>" class="form-control" >  -->
    </div>
...
<div class="row">
    ...
    <div class="col-lg-5">
        <input type="text" value="<?php echo $getrowpi_byid[0]->Bene_country; ?>" class="form-control" > 
    </div>
...
<div class="row">
    ...
    <div class="col-lg-5">
        <input type="text" value="<?php echo $getrowpi_byid[0]->Bene_phone; ?>" class="form-control" > 
    </div>
...
<div class="row">
    ...
    <div class="col-lg-5">
        <input type="text" class="form-control" value="<?php echo $getrowpi_byid[0]->Bene_cp; ?>" > 
    </div>
...
<p style="font-weight: bold;">Purchase Goods</p>
...
<p style="font-weight: bold;">Free Goods</p>
										...
										<div class="widget-summary widget-summary-md">
											...
											<div class="widget-summary-col">
												<div class="summary">
													<h4>CFR:</h4>
													<div class="info">
														<strong class="amount"><?php echo $free_on_board[0]->Total_Purchase+$getrowpi_byid[0]->gexp_pi_freight_cost; ?></strong>
														<!-- <span class="text-primary">(14 unread)</span> -->
													</div>
												</div>
												<div class="summary-footer">
...
<section class="panel panel-featured panel-featured-primary">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Coding Printing</h2>
								</header>
								<div class="panel-body">
                                
<h4 style="font-weight: bold;">Sachet</h4>
<p>Imported By : <?php echo $coding_printing[0]->SacImportby; ?></p>
<p>Consumer Hotline : <?php echo $coding_printing[0]->SacHotline; ?></p>
<p>Best Before : <?php echo $coding_printing[0]->SacBestBefore; ?></p>

<br>
<h4 style="font-weight: bold;">Pouch</h4>
<p>Imported By : <?php echo $coding_printing[0]->PchImportby; ?></p>
<p>Consumer Hotline : <?php echo $coding_printing[0]->PchHotline; ?></p>
<p>Best Before : <?php echo $coding_printing[0]->PchBestBefore; ?></p>

<br>
<h4 style="font-weight: bold;">Case</h4>
<p>Imported By : <?php echo $coding_printing[0]->CasImportby; ?></p>
<p>Consumer Hotline : <?php echo $coding_printing[0]->CasHotline; ?></p>
<p>Best Before : <?php echo $coding_printing[0]->CasBestBefore; ?></p>
...
<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Remark</label>
												<div class="col-md-6">
													<textarea class="form-control" rows="3" id="textareaDefault"><?php echo $getrowpi_byid[0]->gexp_pi_remark ?></textarea>
												</div>
											</div>
<!-- <p>Free On Board (FOB): <?php echo $free_on_board[0]->Total_Purchase; ?></p> -->
