...
<a class="btn btn-warning" href="<?php echo base_url('MenuCheckDocexp/');?>"><i class="fa fa-arrow-left"></i> Back</a>

</div>

							<hr>

							<form class="form-horizontal form-bordered" action="<?php echo base_url('MenuCheckDocexp/TestUploadreq');?>" enctype="multipart/form-data" method="POST">

                                    <input type="hidden" name="expreq_id" value="<?php echo $expreq_rows->gexp_expreq_id; ?>" placeholder="<?php echo $expreq_rows->gexp_expreq_id; ?>" class="form-control" id="inputDefault">

											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Upload Document 1</label>
												<div class="col-md-3">
													<input type="file" name="berkas" class="form-control" id="inputDefault" required>
												</div>
											</div>

											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Upload Document 2</label>
												<div class="col-md-3">
													<input type="file" name="berkas2" class="form-control" id="inputDefault" required>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<textarea class="form-control" name="remarkexp" rows="5"></textarea>
													<small>Maximum character 255</small>
												</div>
                                            </div>
											...
											<div class="form-group">
												...
												<div class="col-md-2">
													<button type="submit" class="btn btn-block btn-primary"><i class="fa fa-upload"></i> Upload</button>
												</div>
											</div>
