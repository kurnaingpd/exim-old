...
<a class="btn btn-warning btn-sm" href="<?php echo base_url('DataSetContainer/');?>"> Back</a>
        
<form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetContainer/save_editmaster_container');?>" id="inputdatagroup" method="POST">

<input type="hidden" value="<?php echo $rows_container->ContainerId ?>" name="container_id">

<div class="form-group">
  <label class="col-md-3 control-label" for="textareaDefault">Container Desc</label>
  <div class="col-md-8">
      <input class="form-control" name="container_desc" value="<?php echo $rows_container->ContainerDesc?>" data-plugin-maxlength maxlength="255" required autocomplete="off" style="text-transform: uppercase;" />
      <p>
...
<div class="form-group">
	<label class="col-md-3 control-label">Status</label>
        ...
        <select data-plugin-selectTwo class="form-control" name="status_container" required>
            <option value="<?php echo $rows_container->ContainerStats ?>"> Selected : 
            <?php if($rows_container->ContainerStats=='1'){
                echo "Active";
            }else{
                echo "InActive";
            } ?></option>
