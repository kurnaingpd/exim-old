...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Master Data Set : Master Container</h5>
							</header>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-success">
        ...
        <h5 class="modal-title" id="exampleModalLabel">Create Master Container</h5>
        
      </div>
      <div class="modal-body">

	  <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetContainer/createnewcontainer');?>" id="inputdatagroup" method="POST">
                                           
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Container Desc<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" name="contdesc" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
...
<?php
if(!empty($lsmastercontainer)){
  // Jika data pada database tidak sama dengan empty (alias ada datanya)
$no_urut=1;
  foreach($lsmastercontainer as $gaa){
    echo "<tr>";
	echo "<th scope='row'>".$no_urut++."</th>";
	echo "<td>".$gaa->ContainerDesc."</td>";
	echo "<td>";
		if($gaa->ContainerStats==1){
			echo "Aktif";
		}else{
			echo "Tidak Aktif";
		}
	...
	echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("DataSetContainer/edit_masterset_container/".$gaa->ContainerId)."'><i class='fa fa-pencil-square-o'></i></a></td>";
