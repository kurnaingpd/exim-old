...
<section class="panel panel-warning">
							...
							<a style="margin-bottom: 25px;" class="mb-md mt-xs mr-xs btn btn-warning" href="<?php echo base_url('MasterGroup');?>"><i class="fa fa-arrow-left"></i> Back</a>
							<a style="margin-bottom: 25px;" class="mb-md mt-xs mr-xs modal-with-move-anim btn btn-warning" href="#modalAnim"><i class="fa fa-pencil-square-o"></i> Edit</a>
