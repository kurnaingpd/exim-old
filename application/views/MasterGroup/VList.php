...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Master Syst : Master Group</h5>
							</header>
							<div class="panel-body">


							<a style="margin-bottom: 25px;" class="mb-md mt-xs mr-xs modal-with-move-anim btn btn-success" href="#modalAnim"><i class="fa fa-plus-square-o"></i> New</a>
...
<div id="modalAnim" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
    <section class="panel panel-success">
        <header class="panel-heading">
            <h2 class="panel-title">Create Master Group</h2>
        </header>
        <div class="panel-body">
            <div class="modal-wrapper">


            <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('MasterGroup/createnewgroup');?>" id="inputdatagroup" method="post">
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Group Desc</label>
												<div class="col-md-8">
													<input class="form-control" name="groupdesc" data-plugin-maxlength maxlength="50" />
													<p>
        ...
        <footer class="panel-footer">
            <div class="row">
                <div class="col-md-12 text-right">
					<button type="submit" class="btn btn-success"><i style="color: white;" class="fa fa-check-square-o"></i> Confirm</button>
...
$no_urut=1;
  foreach($lsmastergroup as $gaa){
    ...
    echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn btn-sm small-btn-ic-info shadow-sm' href='".base_url("MasterGroup/Editmastergroup/".$gaa->GroupId)."'><i class='fa fa-pencil-square-o'></i></a></td>";
    echo "</tr>";
  }
