						...
						<div id="userbox" class="userbox">
							<a href="#" data-toggle="dropdown">
								<figure class="profile-picture">
									<img src="<?= base_url(); ?>assets/template/images/!logged-user.jpg" alt="Image" class="img-circle" data-lock-picture="assets/images/!logged-user.jpg" />
								</figure>
						...
						<header class="page-header" style="background-color: #172774;">
							...
							<section class="panel panel-primary">
								<header class="panel-heading">
									...
									<h5>Proforma Invoice : Add Items</h5>
								</header>
								<div class="panel-body">
									...
									<hr>
									<form class="form-horizontal form-bordered" action="<?php echo base_url('MasterBoardPI/save_item_pi');?>" method="POST">
										<input type="hidden" class="form-control" name="id_pi" value="<?php echo $id_pi; ?>">
										<input type="hidden" class="form-control" name="pi_no" value="<?php echo $listdataPI_byId[0]->gexp_pi_no; ?>">
										<div class="form-group">
											<label class="col-md-1 control-label" for="inputDefault">PI Numbers </label>
											<div class="col-md-3">
												<input type="text" class="form-control" name="" value="<?php echo $listdataPI_byId[0]->gexp_pi_no;?>" id="inputDefault" readonly>
											</div>
										</div>

										<div class="form-group">
											<label class="col-md-1 control-label" for="inputDefault">Required Item</label>
											<div class="col-md-3">
												<select class="form-control" name="required_item" required>
													<option value="">-- Pilih --</option>
													<option value="1"> Purchase Goods </option>
										...
										<div class="form-group">
											<label class="col-md-1 control-label" for="inputDefault">Select Items</label>
											<div class="col-md-4">
												<select class="form-control" name="select_items" required>
													<option value="">-- Pilih --</option>
													<?php foreach($listdata_item as $dt) : ?>
										...
										<div class="form-group">
											<label class="col-md-1 control-label" for="inputDefault">HS Code</label>
											<div class="col-md-3">
												<input type="text" class="form-control" name="hscode" id="inputDefault" required>
											</div>
										</div>

										<div class="form-group">
											<label class="col-md-1 control-label" for="inputDefault">Qty ( Case )</label>
											<div class="col-md-3">
												<?php
													if(empty($qty_cbm)) {
												?>
												...
												?>
												<input type="number" class="form-control" onKeyUp="if(this.value><?=$qty_cbm->remain_qty_max_per_cbm?>){this.value=<?=$qty_cbm->remain_qty_max_per_cbm?>;}else if(this.value<0){this.value=0;}" id="qty" name="qty" required>
												<small>*Notes: Qty tidak boleh lebih dari <b><?=$qty_cbm->remain_qty_max_per_cbm?></b></small>
												<?php
													}
												?>
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<input type="text" class="form-control" name="price" id="inputDefault" required>
											</div>
										</div>
													...
													<div class="modal-body">
														<div class="form-group">
															...
															<div class="col-md-8">
																...
																<p><code>max-length</code> set to 50 character <code>uppercase</code>.</p>
															</div>
														</div>
													</div>
									...
									<table class="table table-bordered table-striped mb-none" id="tables3">
										...
										<tbody>
											<?php if(isset($list_purchasegood)) : ?>
												<?php $no_urut = 1; foreach($list_purchasegood as $gaa) : ?>
												<tr>
													<td scope="row"><?=$no_urut;?></td>
													<td><?=$gaa->ItemName;?></td>
													<td><?=$gaa->gexp_good_hs_code;?></td>
													<td><?=$gaa->ItemPackDesc;?></td>
													<td><?=$gaa->gexp_good_qty;?></td>
													<td><?=$gaa->gexp_good_price;?></td>
													<td><?=$gaa->gexp_good_totals;?></td>
													<td style="text-align:center; font-size:18px;">
														<a style="font-size:18px;" class="btn small-btn-ic-info shadow-sm modal-basic" href="#modalCenterIcon<?php echo $gaa->gexp_good_id?>"><i class="fa fa-trash-o"></i></a>
													</td>

													<div id="modalCenterIcon<?php echo $gaa->gexp_good_id?>" class="modal-block modal-block-primary mfp-hide">
														<section class="panel">
															<form action="<?php echo base_url('MasterBoardPI/deleteitemPI/')?>" method="POST" >
																<div class="panel-body text-center">
																	<div class="modal-wrapper">
																		...
																		<div class="modal-text">
																			<h4>Are you sure?</h4>
																			<p>Are you sure that you want to delete this items ? </p>
																			<input type="hidden" name="no_pi" value="<?php echo $gaa->gexp_good_pi_no ?>">
																			<input type="hidden" name="item_id" value="<?php echo $gaa->gexp_good_id ?>">
																		</div>
																	</div>
																</div>
									...
									<table class="table table-bordered table-striped mb-none" id="tables4">
										...
										<tbody>
											<?php if(isset($list_freegood)) : ?>
												<?php $no_urut = 1; foreach($list_freegood as $gaa) : ?>
												<tr>
													<td scope="row"><?=$no_urut;?></td>
													<td><?=$gaa->ItemName;?></td>
													<td><?=$gaa->gexp_good_hs_code;?></td>
													...
													<td><?=$gaa->gexp_good_totals;?></td>
													<td style="text-align:center; font-size:18px;">
														<a style="font-size:18px;" class="btn small-btn-ic-info shadow-sm modal-basic" href="#modalCenterIcon<?=$gaa->gexp_good_id?>"><i class="fa fa-trash-o"></i></a>
													</td>
													<div id="modalCenterIcon<?php echo $gaa->gexp_good_id?>" class="modal-block modal-block-primary mfp-hide">
														<section class="panel">
															<form action="<?php echo base_url('MasterBoardPI/deleteitemPI/')?>" method="POST" >
