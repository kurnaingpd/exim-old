...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Proforma Invoice : Preview</h5>
							</header>
...
<!-- <a class="btn btn-success" href="<?php echo base_url('MasterBoardPI/CreateNew');?>"><i class="fa fa-file"></i> New</a> -->
        ...
        <a class="btn btn-primary" href="<?php echo base_url('MasterBoardPI');?>"><i class="fa fa-arrow-left"></i> Back</a>
        <!-- <div class="col-lg-2"> -->
...
<div class="row">
    ...
    <div class="col-lg-5">
        <textarea class="form-control" rows="4" data-plugin-maxlength maxlength="255" value="<?php echo $getrowpi_byid[0]->Cons_addr;?>" readonly><?php echo $getrowpi_byid[0]->Cons_addr;?></textarea>
...
<div class="row">
    ...
    <div class="col-lg-5">
    <textarea class="form-control" rows="4" data-plugin-maxlength maxlength="255" value="<?php echo $getrowpi_byid[0]->Bene_addr;?>" readonly><?php echo $getrowpi_byid[0]->Bene_addr;?></textarea>
...
$no_urut=1;
  foreach($list_purchasegood as $gaa){
    ...
    echo "<td>".number_format("$gaa->gexp_good_price",2,".",",")."</td>";
    echo "<td>".number_format("$gaa->gexp_good_totals",2,".",",")."</td>";
										...
										<div class="widget-summary widget-summary-md">
											...
											<div class="widget-summary-col">
												<div class="summary">
													...
													<div class="info">
														<strong class="amount"><?php echo number_format($free_on_board[0]->Total_Purchase,2,'.',','); ?></strong>
										...
										<div class="widget-summary widget-summary-md">
											...
											<div class="widget-summary-col">
												<div class="summary">
													<h4 >Freight Cost :</h4>
													<div class="info">
														<strong class="amount"><?php echo number_format($getrowpi_byid[0]->gexp_pi_freight_cost,2,'.',','); ?></strong>
														<!-- <span class="text-primary">(14 unread)</span> -->
													</div>
												</div>
												<div class="summary-footer">
										...
										<div class="widget-summary widget-summary-md">
											...
											<div class="widget-summary-col">
												<div class="summary">
													<h4 >Insurance:</h4>
													<div class="info">
														<strong class="amount"><?php echo number_format($getrowpi_byid[0]->gexp_pi_insurance,2,'.',','); ?></strong>
														<!-- <span class="text-primary">(14 unread)</span> -->
													</div>
												</div>
												<div class="summary-footer">
										...
										<div class="widget-summary widget-summary-md">
											...
											<div class="widget-summary-col">
												<div class="summary">
													<h4 >CIF:</h4>
													<div class="info">
														<strong class="amount"><?php echo number_format($free_on_board[0]->Total_Purchase+$getrowpi_byid[0]->gexp_pi_freight_cost+$getrowpi_byid[0]->gexp_pi_insurance,2,'.',','); ?></strong>
														<!-- <span class="text-primary">(14 unread)</span> -->
													</div>
												</div>
												<div class="summary-footer">
										...
										<div class="widget-summary widget-summary-md">
											...
											<div class="widget-summary-col">
												<div class="summary">
													<h4>CFR:</h4>
													<div class="info">
														<strong class="amount"><?php echo number_format($free_on_board[0]->Total_Purchase+$getrowpi_byid[0]->gexp_pi_freight_cost,2,'.',','); ?></strong>
														<!-- <span class="text-primary">(14 unread)</span> -->
													</div>
												</div>
												<div class="summary-footer">
...
<div class="form-group">
												...
												<div class="col-md-6">
													<textarea class="form-control" rows="3" id="textareaDefault" readonly><?php echo $getrowpi_byid[0]->gexp_pi_remark ?></textarea>
												</div>
											</div>
