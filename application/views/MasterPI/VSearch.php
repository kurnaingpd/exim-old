...
<div class="container-fluid">
	...
	<a class="btn btn-warning" href="<?php echo base_url('MasterBoardPI');?>"><i class="fa fa-arrow-left"></i> Kembali</a>
	<a class="btn btn-success" href="<?php echo base_url('MasterBoardPI/CreateNew');?>"><i class="fa fa-file"></i> New</a>
							...
							<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('MasterBoardPI/SearchPI');?>">
