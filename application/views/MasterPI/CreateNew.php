...
<a class="btn btn-warning" href="<?php echo base_url('MasterBoardPI');?>"><i class="fa fa-arrow-left"></i> Back</a>
							...
							<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('MasterBoardPI/InsertCreateNew');?>">

<div class="container">
    <h4 style="font-weight: bolder;">Create Proforma Invoice</h4>
</div>
                            ...
                            <hr>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" name="pi_number" value="<?php echo $noticket."/SKP-EXP/PI/".$m."/".$y; ?>" id="inputDefault">
												</div>
                                                <label class="col-md-1 control-label" for="inputDefault">PI Date</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="pi_date" value="<?php echo $datenow ?>" id="inputDefault">
												</div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-4">
													<select name="input_company_consig" data-plugin-selectTwo id="input_company_id" class="form-control input_company_id">
												...
												<textarea class="form-control" rows="3" id="input_CustAddress" name="input_CustAddress" data-plugin-maxlength maxlength="255" disabled></textarea>
													<!-- <select id="basic" data-plugin-selectTwo class="form-control" name="customercountry" disabled>
															<option value="PI Cust">-- Auto --</option> -->
														<!-- <?php foreach($lsmastercountry as $dt) : ?>
															<option value="<?php echo $dt->CountryId;?>">(<?php echo $dt->CountryCode;?>) <?php echo $dt->CountryName;?></option>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-2">
												<input type="text" class="form-control" id="input_CountryName" name="input_CountryName" placeholder="Enter ..." required readonly>
													<!-- <select id="basic" data-plugin-selectTwo class="form-control" name="customercountry" disabled>
															<option value="PI Cust">-- Auto --</option> -->
												   <!-- <?php foreach($lsmastercountry as $dt) : ?>
															<option value="<?php echo $dt->CountryId;?>">(<?php echo $dt->CountryCode;?>) <?php echo $dt->CountryName;?></option>
												...
												<div class="col-md-2">
												<input type="text" class="form-control" id="input_CountryPhone" name="input_CountryPhone" placeholder="Enter ..." required readonly>
													<!-- <select id="basic" data-plugin-selectTwo class="form-control" name="customercountry" disabled>
															<option value="PI Cust">-- Auto --</option> -->
														<!-- <?php foreach($lsmastercountry as $dt) : ?>
															<option value="<?php echo $dt->CountryId;?>">(<?php echo $dt->CountryCode;?>) <?php echo $dt->CountryName;?></option>
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="input_CtConsName" name="input_CtConsName" placeholder="Enter ..." required readonly>
                                            ...
                                            <div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">Company Name</label>
												<div class="col-md-4">
													<select name="input_company_bene" data-plugin-selectTwo id="input_beneficiary_id" class="form-control">
														<option value="">-- Pilih --</option>
												...
												<textarea class="form-control" rows="3" id="input_CustAddress2" name="input_CustAddress2" data-plugin-maxlength maxlength="255" disabled></textarea>
													<!-- <select id="basic" data-plugin-selectTwo class="form-control" name="customercountry" disabled>
															<option value="PI Cust">-- Auto --</option> -->
														<!-- <?php foreach($lsmastercountry as $dt) : ?>
															<option value="<?php echo $dt->CountryId;?>">(<?php echo $dt->CountryCode;?>) <?php echo $dt->CountryName;?></option>
                                            ...
                                            <div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">Country</label>
												<div class="col-md-2">
													<input type="text" class="form-control" id="input_CountryName2" name="input_CountryName2" placeholder="Enter ..." required readonly>
                                                ...
                                                <label class="col-md-2 control-label" for="inputDefault">Phone</label>
												<div class="col-md-2">
													<input type="text" class="form-control" id="input_CountryPhone2" name="input_CountryPhone2" placeholder="Enter ..." required readonly>
													<!-- <select id="basic" data-plugin-selectTwo class="form-control" name="customercountry" disabled>
															<option value="PI Cust">-- Auto --</option> -->
														<!-- <?php foreach($lsmastercountry as $dt) : ?>
															<option value="<?php echo $dt->CountryId;?>">(<?php echo $dt->CountryCode;?>) <?php echo $dt->CountryName;?></option>
                                                ...
                                                <label class="col-md-1 control-label" for="inputDefault">Attention Contact Person</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="input_ContactBene2" name="input_ContactBene2" placeholder="Enter ..." required readonly>
													<!-- <select id="basic" data-plugin-selectTwo class="form-control" name="customercountry" disabled>
															<option value="PI Cust">-- Auto --</option> -->
														<!-- <?php foreach($lsmastercountry as $dt) : ?>
															<option value="<?php echo $dt->CountryId;?>">(<?php echo $dt->CountryCode;?>) <?php echo $dt->CountryName;?></option>
                                            ...
                                            <label class="col-md-1 control-label" for="inputDefault">Loading Port</label>
												<div class="col-md-4">
													<select id="input_loadport" data-plugin-selectTwo class="form-control" name="loadport">
															<option value="PI Cust">-- Select Loading Port --</option>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-4">
													<select id="input_Discharge_port" class="form-control" name="input_Discharge_port">
															<!-- <option value="PI Cust">-- Select Discharge Port --</option> -->
                                                    </select>
												...
												<!-- <input type="text" class="form-control" id="input_DestinationPort" name="input_Destination_port" placeholder="Auto ..." required readonly> -->
													<!-- <select id="basic" data-plugin-selectTwo class="form-control" name="customercountry" disabled>
															<option value="PI Cust">-- Auto --</option> -->
														<!-- <?php foreach($lsmastercountry as $dt) : ?>
															<option value="<?php echo $dt->CountryId;?>">(<?php echo $dt->CountryCode;?>) <?php echo $dt->CountryName;?></option>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-4">
													<select id="basic" data-plugin-selectTwo class="form-control" name="container">
															<option value="PI Cust">-- Select List Container --</option>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-4">
												<input type="text" class="form-control" name="input_container_numb" placeholder="Type ...">
													<!-- <select id="basic" data-plugin-selectTwo class="form-control" name="customercountry"> -->
												...
												<div class="col-md-4">
												<input type="text" class="form-control" name="input_freightcomp" id="input_freightcomp" placeholder="Type ..." required>
													<!-- <select id="basic" data-plugin-selectTwo class="form-control" name="customercountry">
															<option value="PI Cust">-- Free Text --</option> -->
														<!-- <?php foreach($lsmastercountry as $dt) : ?>
															<option value="<?php echo $dt->CountryId;?>">(<?php echo $dt->CountryCode;?>) <?php echo $dt->CountryName;?></option>
                                            ...
                                            <label class="col-md-1 control-label" for="inputDefault">Freight Company Contact</label>
												<div class="col-md-4">
												<input type="text" class="form-control" name="input_freightcomp_contact" id="input_freightcomp_contact" placeholder="Type ..." required>
													<!-- <select id="basic" data-plugin-selectTwo class="form-control" name="customercountry">
															<option value="PI Cust">-- Free Text --</option> -->
														<!-- <?php foreach($lsmastercountry as $dt) : ?>
															<option value="<?php echo $dt->CountryId;?>">(<?php echo $dt->CountryCode;?>) <?php echo $dt->CountryName;?></option>
												...
												<div class="col-md-4">
												<input type="text" class="form-control" name="input_freightcomp_numb" id="input_freightcomp_numb" placeholder="Type ..." required>
													<!-- <select id="basic" data-plugin-selectTwo class="form-control" name="customercountry">
															<option value="PI Cust">-- Free Text --</option> -->
														<!-- <?php foreach($lsmastercountry as $dt) : ?>
															<option value="<?php echo $dt->CountryId;?>">(<?php echo $dt->CountryCode;?>) <?php echo $dt->CountryName;?></option>
                                            ...
                                            <label class="col-md-1 control-label" for="inputDefault">Freight Cost</label>
												<div class="col-md-4">
												<input type="text" class="form-control" name="input_freightcost" placeholder="Type ...">
													<!-- <select id="basic" data-plugin-selectTwo class="form-control" name="customercountry">
												...
												<div class="col-md-4">
												<input type="text" class="form-control" name="input_insurance" placeholder="Type ...">
													<!-- <select id="basic" data-plugin-selectTwo class="form-control" name="customercountry">
															<option value="PI Cust">-- Free Text Summ --</option> -->
														<!-- <?php foreach($lsmastercountry as $dt) : ?>
															<option value="<?php echo $dt->CountryId;?>">(<?php echo $dt->CountryCode;?>) <?php echo $dt->CountryName;?></option>
                                            ...
                                            <label class="col-md-1 control-label" for="inputDefault">Bank Name</label>
												<div class="col-md-4">
													<select id="basic" data-plugin-selectTwo class="form-control" name="input_bank">
															<option value="PI Cust">-- Selected List --</option>
												...
												<div class="col-md-4">
													<select id="basic" data-plugin-selectTwo class="form-control" name="input_currency">
															<option value="PI Cust">-- Selected List --</option>
															<!-- <option value="IDR">IDR</option>
															<option value="USD">USD</option>
															<option value="RMB">RMB</option> -->
														<?php foreach($currency as $dt) : ?>
															<option value="<?php echo $dt->id;?>">(<?php echo $dt->code;?>) <?php echo $dt->name;?></option>
														<?php endforeach; ?>
                                                    </select>
												</div>
                                            </div>
                                            ...
                                            <label class="col-md-1 control-label" for="inputDefault">PPN</label>
												<div class="col-md-4">
													<select id="basic" data-plugin-selectTwo class="form-control" name="ppn">
															<option value="PI Cust">-- Selected List --</option>
												...
												<div class="col-md-4">
												<input type="text" class="form-control" id="input_Top" name="top" placeholder="Auto ..." required readonly>
...
//             value = $.parseJSON(data);
// 			$.each(value,function(i,val){
// 				$('<option>').val(value.ShipportId).text(value.ShipportId).appendTo('#input_Discharge_port');
// 			})
...
// 			$('#input_Top').val(value.TopDesc);
// 			// $('<option>').val(val.ShipportId).text(val.ShipportId).appendTo('#input_Discharge_port');
...
//         $.each(value,function(i,val){
// 			//    $('<option>').val(val.Docim_Id).text(val.Docim_PO).appendTo('#input_po_no');
//                $('<option>').val(value.ShipportId).text(value.DischargePort).appendTo('#input_Discharge_port');
// 			//    $('<option>').val(val.Docim_ID).text(val.Docim_PO).appendTo('#input_po_no');
// 			})
// 		});
