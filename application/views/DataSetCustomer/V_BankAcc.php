...
<section class="panel panel-primary">
							...
							<header class="panel-heading">
								...
								<h5>Add Bank Account : <?php echo $custrow->CustCode ?></h5>
...
<br>
                            ...
                            <h4 style="font-weight:bold;">Customer Bank Account </h4>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-success">
        ...
        <h5 class="modal-title" id="exampleModalLabel">Add Bank Customer</h5>
        
      </div>
      <div class="modal-body">

	  <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetCustomer/insertcustomerbank');?>" id="inputdatagroup" method="POST">
      ...
      <input type="hidden" value="<?php echo $custrow->CustId ?>" name="custid">
											...
											<div class="form-group">
												...
												<div class="col-md-7">
													<input class="form-control" name="bankaccname" data-plugin-maxlength maxlength="50" />
													<p>
											...
											<div class="form-group">
												...
												<div class="col-md-7">
													<input class="form-control" name="bankaccno" data-plugin-maxlength maxlength="50" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-7">
													<input class="form-control" name="bankname" data-plugin-maxlength maxlength="50" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-7">
													<input class="form-control" name="bankbranch" data-plugin-maxlength maxlength="50" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-7">
													<input class="form-control" name="bankaddrs" data-plugin-maxlength maxlength="50" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-7">
													<input class="form-control" name="bankswift" data-plugin-maxlength maxlength="50" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-7">
													<input class="form-control" name="bankcode" data-plugin-maxlength maxlength="50" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
								...
								<table class="table table-bordered table-striped mb-none" id="tables3">
									<thead>
										<tr>
											...
											<th>Customer Bank Address</th>
											<th>Customer Bank Swift Code</th>
                                            <th>Customer Bank Code</th>
											<th>Edit</th>
...
$no_urut=1;
  foreach($lsmasterbank as $gaa){
	...
	echo "<td>".$gaa->BankCustAccountName."</td>";
	echo "<td>".$gaa->BankCustAccountNo."</td>";
	echo "<td>".$gaa->BankCustName."</td>";
	echo "<td>".$gaa->BankCustBranch."</td>";
    echo "<td>".$gaa->BankCustAddress."</td>";
    echo "<td>".$gaa->BankCustSwiftCode."</td>";
    echo "<td>".$gaa->BankCustCode."</td>";
	echo "<td><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("DataSetCustomer/EditBankCustomer/".$gaa->BankCustId)."'><i class='fa fa-pencil-square-o'></i></a></td>";
