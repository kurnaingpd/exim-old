...
<br>
                            ...
                            <h4 style="font-weight:bold;">Import Document</h4>
                            <!-- <h5 style="font-weight:bold;">Ship Company Name : <?php echo $shiperrow->ShipCompanyName ?></h5> -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-success">
        ...
        <h5 class="modal-title" id="exampleModalLabel">Add Import Document</h5>
        
      </div>
      <div class="modal-body">

	  <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetCustomer/insertcustomerimportdoc');?>" method="POST">

                        <input type="hidden" value="<?php echo $custrow->CustId ?>" name="custoid">
                                           			
                                            <div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Bill Of Ladding</label>
												<div class="col-md-7">
													
                                                    <select id="billofladding" class="form-control" name="billofladding" required>
                                                        <option value="">-- Pilih --</option>
                                                        <option value="Not Include">Not Include</option>
                                                        <option value="Send Original Doc">Send Original Doc</option>
                                            ...
                                            <div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Packing List</label>
												<div class="col-md-7">
													
                                                    <select id="packinglist" class="form-control" name="packinglist" required>
                                                        <option value="">-- Pilih --</option>
                                                        <option value="Not Include">Not Include</option>
                                                        <option value="Send Original Doc">Original Doc</option>
                                            ...
                                            <div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Invoice</label>
												<div class="col-md-7">
                                            ...
                                            <div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Invoice Under Value</label>
												<div class="col-md-7">
													
                                                    <select id="invoiceunderv" class="form-control" name="invoiceunderv" required>
                                                        <option value="">-- Pilih --</option>
                                                        <option value="Not Include">Not Include</option>
                                                        <option value="Send Original Doc">Original Doc</option>
                                                        <option value="Send by Email">Send by Email</option>
                                            ...
                                            <div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">COO</label>
												<div class="col-md-7">
													
                                                    <select id="coo" class="form-control" name="coo" required>
                                                        <option value="">-- Pilih --</option>
                                                        <option value="Not Include">Not Include</option>
                                                        <option value="Send Original Doc">Original Doc</option>
                                                        <option value="Send by Email">Send by Email</option>
                                            ...
                                            <div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Health Certificate</label>
												<div class="col-md-7">
													
                                                    <select id="healthcertf" class="form-control" name="healthcertf" required>
                                                        <option value="">-- Pilih --</option>
                                                        <option value="Not Include">Not Include</option>
                                                        <option value="Send Original Doc">Original Doc</option>
                                                        <option value="Send by Email">Send by Email</option>
                                            ...
                                            <div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Material Savety Data Sheet</label>
												<div class="col-md-7">
													
                                                    <select id="materialsavety" class="form-control" name="materialsavety" required>
                                                        <option value="">-- Pilih --</option>
                                                        <option value="Not Include">Not Include</option>
                                                        <option value="Send Original Doc">Original Doc</option>
                                                        <option value="Send by Email">Send by Email</option>
                                            ...
                                            <div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">COA</label>
												<div class="col-md-7">
													
                                                    <select id="coa" class="form-control" name="coa" required>
                                                        <option value="">-- Pilih --</option>
                                                        <option value="Not Include">Not Include</option>
                                                        <option value="Send Original Doc">Original Doc</option>
                                                        <option value="Send by Email">Send by Email</option>
                                            ...
                                            <div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Product Spesifications</label>
												<div class="col-md-7">
													
                                                    <select id="prodspec" class="form-control" name="prodspec" required>
                                                        <option value="">-- Pilih --</option>
                                                        <option value="Not Include">Not Include</option>
                                                        <option value="Send Original Doc">Original Doc</option>
                                                        <option value="Send by Email">Send by Email</option>
                                            ...
                                            <div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Others Add</label>
												<div class="col-md-7">
													
                                                    <input class="form-control" id="othersadd" name="othersadd" data-plugin-maxlength maxlength="50" required />
                                                    <p>
...
<table class="table table-bordered table-striped mb-none" id="tables3">
									<thead>
										<tr>
											...
											<th>Packing List</th>
                                            <th>Invoice</th>
											<th>Invoice UnderValue</th>
                                            <th>COO</th>
											<th>Health Certificate</th>
                                            <th>Material Savety Data Sheet</th>
											<th>COA</th>
                                            <th>Product Spesification</th>
                                            <th>Others</th>
...
<?php
if( ! empty($lsmasterimportdoc)){
  // Jika data pada database tidak sama dengan empty (alias ada datanya)
$no_urut=1;
  foreach($lsmasterimportdoc as $gaa){
    echo "<tr>";
    echo "<th scope='row'>".$no_urut++."</th>";
	echo "<td>".$gaa->BillOfLadding."</td>";
    echo "<td>".$gaa->PackingList."</td>";
    echo "<td>".$gaa->InvoiceA."</td>";
    echo "<td>".$gaa->InvoiceUV."</td>";
    echo "<td>".$gaa->COO."</td>";
    echo "<td>".$gaa->HealthCert."</td>";
    echo "<td>".$gaa->MaterialSafety."</td>";
    echo "<td>".$gaa->COA."</td>";
    echo "<td>".$gaa->ProductSpec."</td>";
    echo "<td>".$gaa->OthersAdd."</td>";
	// echo "<td>".$gaa->ShipCountry."</td>";
	// echo "<td>".$gaa->ShipPhone."</td>";
    // echo "<td>".$gaa->ShiptoCpName."</td>";
    // echo "<td>".$gaa->ShiptoCpPhone."</td>";
    // echo "<td>".$gaa->ShiptoCpEmail."</td>";
	// echo "<td><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("DataSetCustomer/AddShipperPort/".$gaa->ShipCodeCust)."'><i class='fa fa-pencil-square-o'></i></a></td>";
