...
<section class="panel panel-warning">
							...
							<header class="panel-heading">
								...
								<h5 style="color:white;">Edit Bank Account : <?php echo $rowsmaster_cb->BankCustAccountName ?></h5>

							</header>
							<div class="panel-body">

    <a href="<?php echo base_url('DataSetCustomer/AddBankAccount/'.$rowsmaster_cb->BankCustId) ?>" class="btn btn-sm btn-warning">Back</a>

<hr>

<form method="POST" action="<?php echo base_url('DataSetCustomer/save_edit_bankcustomer') ?>">

<input type="hidden" value="<?php echo $rowsmaster_cb->CustCodeId ?>" name="cust_code_id">
<input type="hidden" value="<?php echo $rowsmaster_cb->BankCustId ?>" name="cust_bank_id">

<div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Account Name</label>
												<div class="col-md-7">
													<input class="form-control" name="bankaccname" data-plugin-maxlength maxlength="50" value="<?=$rowsmaster_cb->BankCustAccountName?>" required />
													<p>
											...
											<div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Account No</label>
												<div class="col-md-7">
													<input class="form-control" name="bankaccno" data-plugin-maxlength maxlength="50" value="<?=$rowsmaster_cb->BankCustAccountNo?>" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Customer Bank Name</label>
												<div class="col-md-7">
													<input class="form-control" name="bankname" data-plugin-maxlength maxlength="50" value="<?=$rowsmaster_cb->BankCustName?>" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<!-- <div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Customer Country</label>
												<div class="col-md-7">
											...
											<div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Customer Bank Branch</label>
												<div class="col-md-7">
													<input class="form-control" name="bankbranch" data-plugin-maxlength maxlength="50" value="<?=$rowsmaster_cb->BankCustBranch?>" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
                                            ...
                                            <div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Customer Bank Address</label>
												<div class="col-md-7">
													<input class="form-control" name="bankaddrs" data-plugin-maxlength maxlength="50" value="<?=$rowsmaster_cb->BankCustAddress?>" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
                                            ...
                                            <div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Customer Bank Swift Code</label>
												<div class="col-md-7">
													<input class="form-control" name="bankswift" data-plugin-maxlength maxlength="50" value="<?=$rowsmaster_cb->BankCustSwiftCode?>" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
                                            ...
                                            <div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Customer Bank Code</label>
												<div class="col-md-7">
													<input class="form-control" name="bankcode" data-plugin-maxlength maxlength="50" value="<?=$rowsmaster_cb->BankCustCode?>" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-7">
													...
													<option value="<?php echo $rowsmaster_cb->CtIncoterm ?>">Selected : (<?php echo $rowsmaster_cb->IncotermCode ?>) <?php echo $rowsmaster_cb->IncotermDesc ?></option>
