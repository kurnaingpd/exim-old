...
<form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetCountry/submiteditmastercountry');?>" id="inputdatagroup" method="POST">
                    ...
                    <input type="hidden" value="<?php echo $lsmastercountry[0]->CountryId ?>" name="countryid">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" name="countrycode" value="<?php echo $lsmastercountry[0]->CountryCode ?>" data-plugin-maxlength maxlength="50" />
                                    <p>
                                        <code>*</code>.
                                    </p>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" name="countryname" value="<?php echo $lsmastercountry[0]->CountryName ?>" data-plugin-maxlength maxlength="50" />
                                    <p>
                                        <code>*</code>.
                                    </p>
                                    <!-- <p>
