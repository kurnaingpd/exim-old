...
<section class="panel panel-primary">
							...
							<header class="panel-heading">
								...
								<h5>Master Data Set : Master Set Customer</h5>

							</header>
							<div class="panel-body">

<!-- Button trigger modal -->
<button type="button" class="mb-md mt-xs mr-xs btn btn-success" style="width:150px;" data-toggle="modal" data-target="#exampleModal">
  NEW
</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-success">
        ...
        <h5 class="modal-title" id="exampleModalLabel">Create Master Customer</h5>
        
      </div>
      <div class="modal-body">

	  <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetCustomer/createnewcustomer');?>" id="inputdatagroup" method="POST">
                                           
											<!-- <div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Customer Code</label>
												<div class="col-md-8">
													<input class="form-control" name="customercode" value="<?php echo $noticket; ?>" data-plugin-maxlength maxlength="50" required />
													<p>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="companyname" data-plugin-maxlength maxlength="50" required autocomplete="off" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="customertown" data-plugin-maxlength maxlength="50" required autocomplete="off" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<textarea class="form-control" name="customeraddress" rows="5" required autocomplete="off"></textarea>
													<!-- <input class="form-control" name="customeraddress" data-plugin-maxlength maxlength="255" /> -->
													<p>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<select id="basic" data-plugin-selectTwo class="form-control" name="customercountry" required autocomplete="off">
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="customerphone" data-plugin-maxlength maxlength="50" required autocomplete="off" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
								...
								<table class="table table-bordered table-striped mb-none" id="tables3">
									<thead>
										<tr>
											...
											<th>Import Doc</th>
											<th>Coding Printing</th>
											<th>Freight Customer</th>
											<th>Cust Status</th>
											<th>Preview</th>
											<th>Edit Master</th>
										</tr>
...
<?php
if( ! empty($lsmastercustomer)){
  // Jika data pada database tidak sama dengan empty (alias ada datanya)
$no_urut=1;
  foreach($lsmastercustomer as $gaa){
    echo "<tr>";
    echo "<th scope='row'>".$no_urut++."</th>";
	echo "<td>".$gaa->CustCode."</td>";
	echo "<td>".$gaa->CustCompanyName."</td>";
	echo "<td>".$gaa->CustTown."</td>";
	echo "<td>".$gaa->CustAddress."</td>";
	echo "<td>".$gaa->CountryName."</td>";
	echo "<td>".$gaa->CustPhone."</td>";
	echo "<td><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("DataSetCustomer/AddContactPerson/".$gaa->CustId)."'><i class='fa fa-pencil-square-o'></i></a></td>";
	...
	echo "<td><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("DataSetCustomer/AddShipperTo/".$gaa->CustId)."'><i class='fa fa-pencil-square-o'></i></a></td>";
	echo "<td><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("DataSetCustomer/AddImportDocument/".$gaa->CustId)."'><i class='fa fa-pencil-square-o'></i></a></td>";
	echo "<td><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("DataSetCustomer/AddCodingPrinting/".$gaa->CustId)."'><i class='fa fa-pencil-square-o'></i></a></td>";
	echo "<td><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("DataSetCustomer/AddFreightCustomer/".$gaa->CustId)."'><i class='fa fa-pencil-square-o'></i></a></td>";
	echo "<td>";
    if($gaa->isStatCust==1){
      echo "Aktif";
    }else{
	...
	echo "<td><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("DataSetCustomer/EditMasterCustomer/".$gaa->CustId)."'><i class='fa fa-pencil-square-o'></i></a></td>";
	echo "</tr>";
  }
}
?>
