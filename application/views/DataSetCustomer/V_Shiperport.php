...
<section class="panel panel-primary">
							...
							<header class="panel-heading">
								...
								<h5>Add Ship Port Account : </h5>

							</header>
							<div class="panel-body">

                            <h4 style="font-weight:bold;">Ship Port</h4>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-success">
        ...
        <h5 class="modal-title" id="exampleModalLabel">Add Ship Port</h5>
        
      </div>
      <div class="modal-body">

	  <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetCustomer/insertcustomershipport');?>" id="inputdatagroup" method="POST">

	  <input type="hidden" value="<?php echo $shiperrow->ShiptoId ?>" name="shiptoid">
	  <input type="hidden" value="<?php echo $shiperrow->ShipCodeCust ?>" name="shiptocust">
                                           

											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Discharge Port</label>
												<div class="col-md-7">
													<input class="form-control" name="dischargeport" data-plugin-maxlength maxlength="50" required />
													<p>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Destination Port</label>
												<div class="col-md-7">
													<input class="form-control" name="destinationport" data-plugin-maxlength maxlength="50" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
...
$no_urut=1;
  foreach($lsmastershiperto as $gaa){
	...
	echo "<td>".$gaa->DischargePort."</td>";
	echo "<td>".$gaa->DestinationPort."</td>";
