...
<section class="panel panel-primary">
							...
							<h5>Coding Printing : <?php echo $custrow->CustCode ?></h5>
...
<br>
                            ...
                            <h4 style="font-weight:bold;">Coding Printing </h4>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-success">
        ...
        <h5 class="modal-title" id="exampleModalLabel">Add Coding Printing</h5>
        
      </div>
      <div class="modal-body">

	  <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetCustomer/insertcustomercodingprint');?>" id="inputdatagroup" method="POST">

      <input type="hidden" value="<?php echo $custrow->CustId ?>" name="custoid">

      <!-- Sachet -->                                       
                                        <p style="font-weight: bold;">Sachet :</p>
											<div class="form-group">
												<label class="col-md-12" for="textareaDefault">Imported By : company name, City, Postal Code.</label>
											</div>
											<div class="form-group">
												<div class="col-md-2"></div>
												<div class="col-md-10">
													<input class="form-control" name="sacimport" data-plugin-maxlength maxlength="50" required />
													<p>
											...
											<div class="form-group">
												<label class="col-md-12" for="textareaDefault">Consumer Hotline : ##########</label>
											</div>
											<div class="form-group">
												<div class="col-md-2"></div>
												<div class="col-md-10">
													<input class="form-control" name="sachotline" data-plugin-maxlength maxlength="50" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
                                            ...
                                            <div class="form-group">
												<label class="col-md-12" for="textareaDefault">Best Before : MMM/DD/YYYY [Batch] [HH:MM]</label>
                                            </div>
											<div class="form-group">
												<div class="col-md-2"></div>
												<div class="col-md-10">
													<input class="form-control" name="sacbefore" data-plugin-maxlength maxlength="50" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
    ...
    <!-- End Sachet -->
    <!-- Pouch -->
                                        <p style="font-weight: bold;">Pouch :</p>
											<div class="form-group">
												<label class="col-md-12" for="textareaDefault">Imported By : company name, City, Postal Code.</label>
											</div>
											<div class="form-group">
												<div class="col-md-2"></div>
												<div class="col-md-10">
													<input class="form-control" name="pchimport" data-plugin-maxlength maxlength="50" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
											 ...
											 <div class="col-md-2"></div>
												<div class="col-md-10">
													<input class="form-control" name="pchhotline" data-plugin-maxlength maxlength="50" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="col-md-2"></div>
												<div class="col-md-10">
													<input class="form-control" name="pchbefore" data-plugin-maxlength maxlength="50" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
    ...
    <!-- Case -->
                                        <p style="font-weight: bold;">Case :</p>
											...
											<div class="col-md-2"></div>
												<div class="col-md-10">
													<input class="form-control" name="casimport" data-plugin-maxlength maxlength="50" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												<div class="col-md-2"></div>
												<div class="col-md-10">
													<input class="form-control" name="cashotline" data-plugin-maxlength maxlength="50" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												<div class="col-md-2"></div>
												<div class="col-md-10">
													<input class="form-control" name="casbefore" data-plugin-maxlength maxlength="50" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												<label class="col-md-12" for="textareaDefault">Tambahan Isi Dalam Carton :</label>
											</div>
											<div class="form-group">
												<div class="col-md-2"></div>
												<div class="col-md-10">
													<input class="form-control" name="tambahan_isi" data-plugin-maxlength maxlength="50" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
...
<table class="table table-bordered table-striped mb-none" id="tables3">
									<thead>
										<tr>
											...
											<th>No</th>
											<th>Imported By (Sachet)</th>
											<th>Consumer Hotline (Sachet)</th>
                                            <th>Best Before (Sachet)</th>
											<th>Imported By (Pouch)</th>
											<th>Consumer Hotline (Pouch)</th>
                                            <th>Best Before (Pouch)</th>
                                            <th>Imported By (Case)</th>
											<th>Consumer Hotline (Case)</th>
											<th>Best Before (Case)</th>
											<th>Tambahan Isi Dalam Carton</th>
...
<?php
if( ! empty($lsmastercodingprint)){
  // Jika data pada database tidak sama dengan empty (alias ada datanya)
$no_urut=1;
  foreach($lsmastercodingprint as $gaa){
    echo "<tr>";
    echo "<th scope='row'>".$no_urut++."</th>";
	echo "<td>".$gaa->SacImportby."</td>";
    echo "<td>".$gaa->SacHotline."</td>";
    echo "<td>".$gaa->SacBestBefore."</td>";
    echo "<td>".$gaa->PchImportby."</td>";
    echo "<td>".$gaa->PchHotline."</td>";
    echo "<td>".$gaa->PchBestBefore."</td>";
    echo "<td>".$gaa->CasImportby."</td>";
    echo "<td>".$gaa->CasHotline."</td>";
	echo "<td>".$gaa->CasBestBefore."</td>";
	echo "<td>".$gaa->TambahanIsi_carton."</td>";
