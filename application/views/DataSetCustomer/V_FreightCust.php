...
<a href="<?php echo base_url('DataSetCustomer'); ?>" class="mb-md mt-xs mr-xs btn btn-warning" style="width:150px;">
  BACK
</a>
...
<h4 style="font-weight: bold;">COMPANY NAME : <?php echo $dt_customer->CustCompanyName ?></h4>
...
<div class="row">
    ...
    <div class="col-lg-6">
        ...
        <section class="panel panel-primary" style="border-color:#3498db; border-style:solid; border-radius:10px;">

							<header class="panel-heading">
								<div class="panel-actions"></div>
								<h5>Master Set Freight Customer : <?php echo $dt_customer->CustCompanyName ?></h5>
							</header>
							<div class="panel-body">

                            <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetCustomer/SubmitFreight_Customer');?>" id="inputdatagroup" method="POST">

                                <input type="hidden" value="<?php echo $dt_customer->CustId ?>" name="custid">
                                    
                                        <div class="form-group">
                                            <label class="col-md-3" for="textareaDefault" style="font-weight: 700;">Freight Name</label>
                                            <div class="col-md-8">
                                                <input class="form-control" name="freight_name" data-plugin-maxlength maxlength="50"  required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3" for="textareaDefault" style="font-weight: 700;">Freight Contact Name</label>
                                            <div class="col-md-8">
                                                <input class="form-control" name="freight_contact" data-plugin-maxlength maxlength="50" required/>
                                                
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3" for="textareaDefault" style="font-weight: 700;">Freight Contact Number</label>
                                            <div class="col-md-8">
                                                <input class="form-control" name="freight_contact_number" data-plugin-maxlength maxlength="50" required/>
                                                
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3" for="textareaDefault" style="font-weight: 700;"></label>
                                            <div class="col-md-8">
                                                <button type="submit" class="btn btn-success" style="width:150px;">Tambah</button>
                                            </div>
                                        </div>
                            </form>
                            ...
                            <table class="table table-bordered table-striped mb-none" id="tables3">
									<thead>
										<tr>
											<th>No</th>
											<th>FREIGHT NAME</th>
											<th>FREIGHT CONTACT NAME</th>
											<th>FREIGHT CONTACT NUMBER</th>
                                            <!-- <th>EDIT</th> -->
                                            <th>DELETE</th>
										</tr>
									</thead>
...
$no_urut=1;
  foreach($ls_freight as $gaa){
    echo "<tr>";
    echo "<th scope='row'>".$no_urut++."</th>";
        echo "<td>".$gaa->freight_company."</td>";
        echo "<td>".$gaa->freight_company_contact."</td>";
        echo "<td>".$gaa->freight_company_number."</td>";
        echo "<td><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("DataSetCustomer/DeleteFreight_Customer/".$gaa->freightid)."'><i class='fa fa-trash-o'></i></a></td>";
        // echo "<td>
        //     <form method='POST' action='".base_url("DataSetCustomer/DeleteFreight_Customer")."'>
        //         <input type='hidden' class='form-control' name='freightid' value='.$gaa->freightid.'> 
        //         <input type='hidden' class='form-control' name='freightcustid' value='.$gaa->freightcust_id.'> 
        //         <button type='submit' class='btn small-btn-ic-info shadow-sm'><i class='fa fa-trash-o'></i></button>
        //     </form>
        // </td>";
    echo "</tr>";
  }
