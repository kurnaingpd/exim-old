...
<section class="panel panel-primary">
							...
							<header class="panel-heading">
								...
								<h5>Add Ship-To Address Account : <?php echo $custrow->CustCode ?></h5>
...
<br>
                            ...
                            <h4 style="font-weight:bold;">Customer Ship-To Address </h4>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-success">
        ...
        <h5 class="modal-title" id="exampleModalLabel">Add Ship-To Address Customer</h5>
        
      </div>
      <div class="modal-body">

	  <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetCustomer/insertcustomershipto');?>" id="inputdatagroup" method="POST">
      ...
      <input type="hidden" value="<?php echo $custrow->CustId ?>" name="custid">
											...
											<div class="form-group">
												...
												<div class="col-md-7">
													<input class="form-control" name="companyname" data-plugin-maxlength maxlength="50" required />
													<p>
											...
											<div class="form-group">
												...
												<div class="col-md-7">
													<textarea class="form-control" name="address" data-plugin-maxlength maxlength="300" required></textarea>
													<p>
														<code>max-length</code> set to 300 character.
													</p>
												</div>
                                            </div>
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Country</label>
												<div class="col-md-7">
													<input class="form-control" name="country" data-plugin-maxlength maxlength="50" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Phone</label>
												<div class="col-md-7">
													<input class="form-control" name="phone" data-plugin-maxlength maxlength="50" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
                                            ...
                                            <div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Cp ( Name )</label>
												<div class="col-md-7">
													<input class="form-control" name="cpname" data-plugin-maxlength maxlength="50" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
                                            ...
                                            <div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Cp ( Phone )</label>
												<div class="col-md-7">
													<input class="form-control" name="cpphone" data-plugin-maxlength maxlength="50" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
                                            ...
                                            <div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Cp ( Email )</label>
												<div class="col-md-7">
													<input type="email" class="form-control" name="cpemail" data-plugin-maxlength maxlength="50" required />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
								...
								<table class="table table-bordered table-striped mb-none" id="tables3">
									<thead>
										<tr>
                                            ...
                                            <th>Cp Ship To (Name)</th>
                                            <th>Cp Ship To (Phone)</th>
                                            <th>Cp Ship To (Email)</th>
                                            <th>Add Port</th>
...
<?php
if( ! empty($lsmastershiperto)){
  // Jika data pada database tidak sama dengan empty (alias ada datanya)
$no_urut=1;
  foreach($lsmastershiperto as $gaa){
    echo "<tr>";
    echo "<th scope='row'>".$no_urut++."</th>";
	echo "<td>".$gaa->ShipCompanyName."</td>";
	echo "<td>".$gaa->ShipAddress."</td>";
