...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Master Data Set : Master Set Item</h5>
							</header>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-success">
        ...
        <h5 class="modal-title" id="exampleModalLabel">Create Master Item</h5>
        
      </div>
      <div class="modal-body">

	  <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetItem/createnewitem');?>" id="inputdatagroup" method="POST">

	  										<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Item Code Id</label>
												<div class="col-md-8">
													<input class="form-control" name="itemcodeid" data-plugin-maxlength maxlength="255" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
											...
											<!-- <div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Item HS Code</label>
												<div class="col-md-8">
													<input class="form-control" name="itemhscode" data-plugin-maxlength maxlength="50" />
													<p>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Item Brand Name<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" name="itembrandname" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Item Name<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" name="itemname" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Item Pack Desc<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" name="itempackdesc" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Item Net Weight (KG)<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" name="itemnetweight" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Item Gross Weight (KG)<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" name="itemgrossweight" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Length<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" name="Length" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Width<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" name="Width" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Height<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" name="Height" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<!-- <div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Item Dimension Carton (MM)<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" name="itemdimension" data-plugin-maxlength maxlength="50" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
								...
								<table class="table table-bordered table-striped mb-none" id="tables3">
									<thead>
										<tr>
											...
											<th>Item Name</th>
											<th>Item Pack Description</th>
											<th>Item Net Weight (KG)</th>
									...
									<?php
if(!empty($lsmasteritem)){
  // Jika data pada database tidak sama dengan empty (alias ada datanya)
$no_urut=1;
  foreach($lsmasteritem as $gaa){
    echo "<tr>";
	echo "<th scope='row'>".$no_urut++."</th>";
	echo "<td>".$gaa->ItemCodeId."</td>";
	// echo "<td>".$gaa->ItemHsCode."</td>";
	echo "<td>".$gaa->ItemBrandName."</td>";
	echo "<td>".$gaa->ItemName."</td>";
	echo "<td>".$gaa->ItemPackDesc."</td>";
	echo "<td>".$gaa->ItemNetWeight."</td>";
	echo "<td>".$gaa->ItemGrossWeight."</td>";
	echo "<td>".$gaa->Length."</td>";
	echo "<td>".$gaa->Width."</td>";
	echo "<td>".$gaa->Height."</td>";
	// echo "<td>".$gaa->ItemDimension."</td>";
    ...
    echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("DataSetItem/Edit_masteritem/".$gaa->ItemId)."'><i class='fa fa-pencil-square-o'></i></a></td>";
    echo "</tr>";
  }
