...
<section class="panel panel-warning">
							<header class="panel-heading">
								...
								<h5  style="color:white;">Master Data Set : Edit Master Set Item</h5>
							</header>
		<div class="panel-body">

<a class="btn btn-warning btn-sm" href="<?php echo base_url('DataSetItem/');?>"> Back</a>
        
<form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetItem/save_editmasteritem');?>" id="inputdatagroup" method="POST">

<input type="hidden" value="<?php echo $rowsdata_itembyid->ItemId ?>" name="itemid">

<div class="form-group">
  <label class="col-md-3 control-label" for="textareaDefault">Item Code Id</label>
  <div class="col-md-8">
      <input class="form-control" name="itemcodeid" value="<?php echo $rowsdata_itembyid->ItemCodeId ?>" data-plugin-maxlength maxlength="255" required autocomplete="off" style="text-transform: uppercase;" />
      <p>
...
<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="itembrandname" value="<?php echo $rowsdata_itembyid->ItemBrandName ?>" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
...
<div class="form-group">
	<label class="col-md-3 control-label" for="textareaDefault">Item Name<code>*</code></label>
		<div class="col-md-8">
			<input class="form-control" name="itemname" value="<?php echo $rowsdata_itembyid->ItemName ?>" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" />
				<p>
					<code>max-length</code> set to 50 character.
				</p>
		</div>
...
<div class="form-group">
	<label class="col-md-3 control-label" for="textareaDefault">Item Pack Desc<code>*</code></label>
		<div class="col-md-8">
			<input class="form-control" name="itempackdesc" value="<?php echo $rowsdata_itembyid->ItemPackDesc ?>" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" />
				<p>
					<code>max-length</code> set to 50 character.
				</p>
		</div>
...
<div class="form-group">
	<label class="col-md-3 control-label" for="textareaDefault">Item Net Weight (KG)<code>*</code></label>
		<div class="col-md-8">
			<input class="form-control" name="itemnetweight" value="<?php echo $rowsdata_itembyid->ItemNetWeight ?>" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" />
				<p>
					<code>max-length</code> set to 50 character.
				</p>
		</div>
...
<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="itemgrossweight" value="<?php echo $rowsdata_itembyid->ItemGrossWeight ?>" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
...
<div class="form-group">
	<label class="col-md-3 control-label" for="textareaDefault">Length<code>*</code></label>
		<div class="col-md-8">
			<input class="form-control" name="Length" value="<?php echo $rowsdata_itembyid->Length ?>" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" />
				<p>
					<code>max-length</code> set to 50 character.
				</p>
		</div>
...
<div class="form-group">
	<label class="col-md-3 control-label" for="textareaDefault">Width<code>*</code></label>
		<div class="col-md-8">
			<input class="form-control" name="Width" value="<?php echo $rowsdata_itembyid->Width ?>" data-plugin-maxlength maxlength="50" />
				<p>
					<code>max-length</code> set to 50 character.
				</p>
		</div>
...
<div class="form-group">
	<label class="col-md-3 control-label" for="textareaDefault">Height<code>*</code></label>
		<div class="col-md-8">
			<input class="form-control" name="Height" value="<?php echo $rowsdata_itembyid->Height ?>" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" />
				<p>
					<code>max-length</code> set to 50 character.
				</p>
		</div>
...
<div class="form-group">
	<label class="col-md-3 control-label">Status</label>
        ...
        <select data-plugin-selectTwo class="form-control" name="status_item" required>
            <option value="<?php echo $rowsdata_itembyid->ItemStats ?>"> Selected : 
            <?php if($rowsdata_itembyid->ItemStats=='1'){
                echo "Active";
            }else{
                echo "InActive";
            } ?></option>
			...
			<!-- <?php foreach($lsmastercountry as $dt) : ?>
				<option value="<?php echo $dt->CountryId;?>"><?php echo $dt->CountryName; ?></option>
			<?php endforeach; ?> -->
        </select>
