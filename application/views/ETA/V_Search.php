...
<a class="mb-xs mt-xs mr-xs btn btn-primary" href="<?php echo base_url('ETA/tambah_data'); ?>"><i class="fa fa-plus-circle"></i> Tambah Data</a>


<div class="row">
<br>
<form class="form-horizontal form-bordered" method="post" action="<?php echo base_url('ETA/get_filter_search'); ?>">
                                            
                                            <div class="form-group">
												<label class="col-md-1 control-label" style="font-weight: 600; color:black;" for="inputDefault">Shipper</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="shipper">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="po_no">
													<!-- <select id="basic" data-plugin-selectTwo class="form-control" name="customercountry">
															<option value="">-- Pilih --</option>
														<?php foreach($lsmastercountry as $dt) : ?>
															<option value="<?php echo $dt->CountryId;?>">(<?php echo $dt->CountryCode;?>) <?php echo $dt->CountryName;?></option>
											...
											<div class="form-group">
												<label class="col-md-1 control-label" style="font-weight: 600; color:black;" for="inputDefault">ETD</label>
												<div class="col-md-2">
													<input type="date" class="form-control" id="inputDefault" name="etd">
												</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-md-1 control-label" style="font-weight: 600; color:black;" for="inputDefault">ETA</label>
												<div class="col-md-2">
													<input type="date" class="form-control" id="inputDefault" name="eta">
												</div>
											</div>
...
<form method="POST" action="<?php echo base_url('ETA/export_excel_eta_bysearch'); ?>">
	...
	<button type="submit" class="btn btn-success"><i class="fa fa-table"></i> EXCEL</button>
</form>

	<!-- <a class="btn btn-success" href="<?php echo base_url('ETA/export_excel_eta'); ?>"><i class="fa fa-table"></i> EXCEL</a> -->
</div>
<br>
<table class="table table-bordered table-striped mb-none" id="tables3">
                                    ...
                                    <?php
if(!empty($searchbydata)){
  // Jika data pada database tidak sama dengan empty (alias ada datanya)
$no_urut=1;
  foreach($searchbydata as $gaa){ ?>

<tr>
										<td> 
											<a style="margin-right: 10px;" role="menuitem" class="mb-xs mt-xs mr-xs modal-with-zoom-anim btn btn-danger" tabindex="-1" href="#modalDelete<?php echo $gaa->etapib_id; ?>"><i class="fa fa-trash-o"></i></a>
										 <!-- Modal Animation -->
											<div id="modalDelete<?php echo $gaa->etapib_id; ?>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
											<section class="panel panel-danger">
												...
												<div class="panel-body">
													<div class="modal-wrapper">
														...
														<form action="<?php echo base_url('ETA/submit_delete_data'); ?>" method="POST">
															<input type="hidden" value="<?php echo $gaa->etapib_id; ?>" name="etapib_id">
															<p>Apakah anda yakin ingin menghapus data ini ?</p>
															<strong><p><?php echo $gaa->etapib_id; ?>, <?php echo $gaa->etapib_shipper; ?></p></strong>
														</div>
													</div>
												</div>
												<footer class="panel-footer">
											...
											<a style="margin-right: 10px;" role="menuitem" class="mb-xs mt-xs mr-xs modal-with-zoom-anim btn btn-warning" tabindex="-1" href="#modalEdit<?php echo $gaa->etapib_id; ?>"> <i class="fa fa-pencil-square-o"></i></a>
											<!-- Modal Animation -->
											<div id="modalEdit<?php echo $gaa->etapib_id; ?>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
											<section class="panel panel-warning">
												...
												<div class="panel-body">
													<div class="modal-wrapper">
														...
														<div class="modal-text" style="color:black; font-size:14px; padding:5px; margin-top:-20px; ">
														<form action="<?php echo base_url('ETA/edit_master_eta'); ?>" method="POST">
                                                            <input type="hidden" value="<?php echo $gaa->etapib_id; ?>" name="etapib_id">
                                        ...
                                        <td><?php if($gaa->etapib_consignee=='1'){
											echo "GDA ( Global Dairy Alami )";
										}elseif($gaa->etapib_consignee=='2'){
                                        ...
                                        <td><?php echo number_format("$gaa->etapib_aktual_pembulatan",0,",","."); ?></td>
