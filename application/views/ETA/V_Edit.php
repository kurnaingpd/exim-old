...
<div class="row">
<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('ETA/submit_edit_data'); ?>">
...
<!-- <a class="mb-xs mt-xs mr-xs btn btn-danger" href="<?php echo base_url('ETA/tambah_data'); ?>"><i class="fa fa-recycle"></i> Reset</a> -->
<button type="submit" style="width:150px;" class="mb-xs mt-xs mr-xs btn btn-warning"><i class="fa fa-save"></i> UPDATES</button>
...
<div class="form-group">
												...
												<label style="font-weight: 600; color:black; border-style:solid; border-color:#172774; padding:10px; border-width:0.5px; background-color:white; font-size:16px;" class="col-md-12" for="inputDefault">EDIT ETA & PIB PAYMENT</label>
												<!-- <div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" readonly>
												</div> -->
                                            </div>
                                            
											<input type="hidden" class="form-control" id="inputDefault" value="<?php echo $rows_eta->etapib_id ?>" name="etapib_id">
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<select id="basic" data-plugin-selectTwo class="form-control" name="status" required>
															<option value="<?php echo $rows_eta->etapib_stats ?>">Selected : <?php if($rows_eta->etapib_stats=='1'){
                                                                echo "Active";
                                                            }else{
                                                                echo "Not Active";
                                                            } ?></option>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
                                                    ...
                                                    <!-- <option value="">-- Pilih --</option> -->
															<option value="<?php echo $rows_eta->etapib_shipper ?>">Selected : <?php echo $rows_eta->etapib_shipper ?></option>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<select id="input_po_no" class="form-control" name="input_po_no" >
															<option value="<?php echo $rows_eta->etapib_po ?>"> Selected : <?php echo $rows_eta->etapib_po ?></option>
                                                    </select>
												</div>
											</div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" name="input_consignee" id="input_consignee" value="<?php echo $rows_eta->etapib_consignee ?>" readonly>
												</div>
											</div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" name="input_commodity" id="input_commodity" value="<?php echo $rows_eta->etapib_commodity ?>" readonly>
												</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-md-1" for="inputDefault">BL No</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="bl_no" id="bl_no" value="<?php echo $rows_eta->etapib_BL_no ?>" readonly>
												</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-md-1" for="inputDefault">POL</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="pol" id="pol" value="<?php echo $rows_eta->etapib_pol ?>" readonly>
												</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-md-1" for="inputDefault">POD</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="pod" name="pod" value="<?php echo $rows_eta->etapib_pod ?>" readonly>
												</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-md-1" for="inputDefault">ETD</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="etd" name="etd" value="<?php echo $rows_eta->etapib_etd ?>" readonly>
												</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-md-1" for="inputDefault">ETA</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="eta" name="eta" value="<?php echo $rows_eta->etapib_eta ?>" readonly>
												</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-md-1" for="inputDefault">PIB AJU</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="pib_aju" name="pib_aju" value="<?php echo $rows_eta->etapib_pib_aju ?>" readonly>
												</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-md-1" for="inputDefault">Currency</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="A" name="A" value="<?php echo $rows_eta->etapib_currency ?>" readonly>
												</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-md-1" for="inputDefault">CIF</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="B" name="B" value="<?php echo $rows_eta->etapib_CIF ?>" readonly>
												</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-md-1" for="inputDefault">Duty</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="C" name="C" value="<?php echo $rows_eta->etapib_Duty ?>" readonly>
												</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-md-1" for="inputDefault">Vat</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="D" name="D" value="<?php echo $rows_eta->etapib_Vat ?>" readonly>
												</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-md-1" for="inputDefault">Tax</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="E" name="E" value="<?php echo $rows_eta->etapib_Tax ?>" readonly>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="G" name="G" value="<?php echo $rows_eta->etapib_CIF_2 ?>" readonly>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="H" name="H" value="<?php echo $rows_eta->etapib_Duty_2 ?>" readonly>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="I" name="I" value="<?php echo $rows_eta->etapib_Vat_2 ?>" readonly>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="J" name="J" value="<?php echo $rows_eta->etapib_Tax_2 ?>" readonly>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="K" name="K" value="<?php echo number_format("$rows_eta->etapib_estimasi",0,",","."); ?>" readonly>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" name="actual" id="L" class="form-control" id="inputDefault" value="<?php echo number_format("$rows_eta->etapib_aktual_pembulatan",0,",","."); ?>" required>
													<small>Jangan ditulis dengan koma atau titik, hanya angka</small>
												</div>
                                            </div>
