...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Dashboard PI : Approval Required Doc Proforma Invoice</h5>
							</header>
...
<!-- <a class="btn btn-success" href="<?php echo base_url('MasterBoardPI/CreateNew');?>"><i class="fa fa-file"></i> New</a> -->
							...
							<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('MenuListDocExp/revised_expreq/'.$exprowsdata->gexp_expreq_id);?>">

											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Noted Revisi Doc :</label>
												<div class="col-md-6">
                                                    <!-- <input type="text" class="form-control" id="inputDefault"> -->
                                                    <textarea class="form-control" rows="5" data-plugin-maxlength maxlength="250" name="note_doc" required></textarea>
												</div>
                                            </div>
											...
											<div class="form-group">
												...
												<div class="col-md-2">
													<button type="submit" class="btn btn-block btn-primary"><i class="fa fa-save"></i> Revisi</button>
												</div>
											</div>
