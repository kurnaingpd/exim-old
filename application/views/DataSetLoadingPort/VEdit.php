...
<section class="panel panel-warning">
            ...
            <header class="panel-heading">
                ...
                <h5 style="color: white;">Master Data Set : Master Set Loading Port</h5>

            </header>
            <div class="panel-body">

            <a style="margin-bottom: 25px;" class="mb-md mt-xs mr-xs btn btn-warning" href="<?php echo base_url('DataSetLoadport/');?>">Back</a>
...
<h5 class="modal-title" id="exampleModalLabel">Edit Master TOP</h5>

</div>
<div class="modal-body">

<form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetLoadport/submiteditmasterloadport');?>" id="inputdatagroup" method="POST">

                    <input type="hidden" value="<?php echo $lsmasterloadport[0]->LoadPortId ?>" name="loadportid">
                           
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="textareaDefault">TOP Description</label>
                                <div class="col-md-8">
                                    <input class="form-control" name="loadportdesc" value="<?php echo $lsmasterloadport[0]->LoadPortDesc ?>" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" />
                                    <p>
                                        <code>*</code>.
                                    </p>
                                </div>
                            ...
                            <div class="form-group">
												...
												<div class="col-md-8">
													<select id="basic" data-plugin-selectTwo class="form-control" name="status_id" required>
                                                        <option value="<?php echo $lsmasterloadport[0]->LoadPortStats; ?>">Selected : 
                                                            <?php if($lsmasterloadport[0]->LoadPortStats=='1'){
                                                                echo "Aktif";
                                                            }else{
                                                                echo "Tidak Aktif";
                                                            }?> 
...
<!-- End Modal Insert Group -->
                ...
                <table class="table table-bordered table-striped mb-none" id="tables3">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Loading Port Desc</th>
                            <th>Loading Port Stats</th>
                            <!-- <th>Action</th> -->
