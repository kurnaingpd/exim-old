...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Master Syst : Master Assign Menu</h5>
							</header>
							<div class="panel-body">


							<form class="form-horizontal form-bordered form-bordered" id="inputdatagroup" method="POST" action="<?php echo base_url('MasterAssignMenu/save_master_menuassign'); ?>">

											<div class="form-group">
												<label class="col-md-1 control-label" for="textareaDefault">Group Name</label>
												<div class="col-md-4">
													<select id="basic" data-plugin-selectTwo class="form-control" name="groupmenu">
														<option value="">-- Pilih --</option>
														<?php foreach($lsmastergroup as $dt) : ?>
											...
											<div class="form-group">
												<label class="col-md-1 control-label" for="textareaDefault">Menus Name</label>
												<div class="col-md-4">
													<select id="basic" data-plugin-selectTwo class="form-control" name="menuid">
														<option value="">-- Pilih --</option>
														<?php foreach($lsmastermenu as $dt) : ?>
															<option value="<?php echo $dt->MenusId;?>"><?php echo $dt->MenusName; ?> - ( <?php echo $dt->MenusLink;?> ) - (
																<?php if($dt->MenuParents=='0'){
																	echo "Head";
																}else{
																	echo "Sub";
																} ?>
											...
											<div class="form-group">
												<label class="col-md-1 control-label" for="textareaDefault"></label>
												<div class="col-md-4">
...
<?php
if( ! empty($lsmasterassign)){
  // Jika data pada database tidak sama dengan empty (alias ada datanya)
$no_urut=1;
  foreach($lsmasterassign as $gaa){
    echo "<tr>";
    echo "<th scope='row'>".$no_urut++."</th>";
	echo "<td>".$gaa->GroupDesc."</td>";
	echo "<td>".$gaa->MenusName."</td>";
	echo "<td>".$gaa->MenusLink."</td>";
	echo "<td>";
	if($gaa->MenuParents=='0'){
		echo "<div style='color:orange; font-weight:800;'>HeadMenu</div>";
	}else{
		echo "<div style='color:purple; font-weight:800;'>SubMenu</div>";
	}
	echo"</td>";
	echo "<td>";
    if($gaa->AssignStats==1){
      echo "<div style='color:green;'>Aktif</div>";
    }else{
      echo "<div style='color:red;'>Tidak Aktif</div>";
    }
	echo"</td>";
	// echo "<td>".$gaa->UpdateAt."</td>";
	// echo "<td>".$gaa->UpdateBy."</td>";
	echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("MasterAssignMenu/Nonactive_assign/".$gaa->AssignId)."'><i class='fa fa-times'></i></a></td>";
	
	echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("MasterAssignMenu/Activated_assign/".$gaa->AssignId)."'><i class='fa fa-check-square-o'></i></a></td>";
