...
<section class="panel panel-warning">
							<header class="panel-heading">
								...
								<h5 style="color:white;">Master Data Set : Edit Master Bank</h5>
							</header>
							<div class="panel-body">

                            <a href="<?php echo base_url('DataSetBank');?>" class="btn btn-warning btn-sm">Back</a>

                            <hr>

                            <form action="<?php echo base_url('DataSetBank/save_edit_master_bank');?>" method="POST">

                            <input type="hidden" value="<?php echo $rowsmasterbank_byid->BankId ?>" name="bankid">

                                            <div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Bank Code<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" value="<?php echo $rowsmasterbank_byid->BankCode ?>" name="bankcode" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*?)\..*/g, '$1');" />
													<p>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Bank Name<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" value="<?php echo $rowsmasterbank_byid->BankName ?>" name="bankname" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Bank Office<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" value="<?php echo $rowsmasterbank_byid->BankOffice ?>" name="bankoffice" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Bank Address<code>*</code></label>
												<div class="col-md-8">
												<textarea class="form-control" rows="5" name="bankdesc" value="<?php echo $rowsmasterbank_byid->BankDesc ?>" required autocomplete="off" style="text-transform: uppercase;"><?php echo $rowsmasterbank_byid->BankDesc ?></textarea>
													<!-- <input class="form-control" value="<?php echo $rowsmasterbank_byid->BankDesc ?>" name="bankdesc" data-plugin-maxlength maxlength="50" /> -->
													<!-- <p>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Bank Account<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" value="<?php echo $rowsmasterbank_byid->BankAccount ?>" name="bankaccount" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Bank Swift Code<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" value="<?php echo $rowsmasterbank_byid->BankSwiftCode ?>" name="bankswiftcode" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-8">
													<select id="basic" data-plugin-selectTwo class="form-control" name="status_id" required>
                                                        <option value="<?php echo $rowsmasterbank_byid->BankStats; ?>">Selected : 
                                                            <?php if($rowsmasterbank_byid->BankStats=='1'){
                                                                echo "Aktif";
                                                            }else{
                                                                echo "Tidak Aktif";
                                                            }?> 
