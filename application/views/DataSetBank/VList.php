...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Master Data Set : Master Bank</h5>
							</header>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-success">
        ...
        <h5 class="modal-title" id="exampleModalLabel">Create Master Country</h5>
        
      </div>
      <div class="modal-body">

	  <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetBank/createnewbank');?>" id="inputdatagroup" method="POST">
                                           
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Bank Code<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" name="bankcode" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*?)\..*/g, '$1');" />
													<p>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="bankname" data-plugin-maxlength maxlength="255" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="bankoffice" data-plugin-maxlength maxlength="255" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<textarea class="form-control" rows="5" name="bankdesc" required autocomplete="off" style="text-transform: uppercase;"></textarea>
													<!-- <input class="form-control" name="bankdesc" data-plugin-maxlength maxlength="255" /> -->
													<!-- <p>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="bankaccount" data-plugin-maxlength maxlength="255" required autocomplete="off" style="text-transform: uppercase;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="bankswiftcode" data-plugin-maxlength maxlength="255" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
														<code>max-length</code> set to 50 character.
													</p>
												</div>
...
<?php
if(!empty($lsmasterbank)){
  // Jika data pada database tidak sama dengan empty (alias ada datanya)
$no_urut=1;
  foreach($lsmasterbank as $gaa){
    echo "<tr>";
	echo "<th scope='row'>".$no_urut++."</th>";
	echo "<td>".$gaa->BankCode."</td>";
	echo "<td>".$gaa->BankName."</td>";
	echo "<td>".$gaa->BankOffice."</td>";
	echo "<td>".$gaa->BankDesc."</td>";
	...
	echo"</td>";
    echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("DataSetBank/editmaster_bank/".$gaa->BankId)."'><i class='fa fa-pencil-square-o'></i></a></td>";
    echo "</tr>";
  }
}
?>		
