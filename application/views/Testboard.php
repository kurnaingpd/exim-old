...
<html class="fixed">
	<head>
		...
		<link rel="stylesheet" href="<?= base_url(); ?>assets/template/vendor/morris/morris.css" />
	...
	<body>
		...
		<!-- Vendor -->
		<script src="<?php echo base_url('assets/template/vendor/jquery/jquery.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/jquery-browser-mobile/jquery.browser.mobile.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/bootstrap/js/bootstrap.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/nanoscroller/nanoscroller.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/bootstrap-datepicker/js/bootstrap-datepicker.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/magnific-popup/magnific-popup.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/jquery-placeholder/jquery.placeholder.js');?>"></script>
		
		<!-- Specific Page Vendor -->
		<script src="<?php echo base_url('assets/template/vendor/jquery-ui/js/jquery-ui-1.10.4.custom.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/jquery-ui-touch-punch/jquery.ui.touch-punch.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/jquery-appear/jquery.appear.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/bootstrap-multiselect/bootstrap-multiselect.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/jquery-easypiechart/jquery.easypiechart.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/flot/jquery.flot.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/flot-tooltip/jquery.flot.tooltip.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/flot/jquery.flot.pie.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/flot/jquery.flot.categories.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/flot/jquery.flot.resize.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/jquery-sparkline/jquery.sparkline.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/raphael/raphael.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/morris/morris.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/gauge/gauge.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/snap-svg/snap.svg.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/liquid-meter/liquid.meter.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/jqvmap/jquery.vmap.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/jqvmap/data/jquery.vmap.sampledata.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/jqvmap/maps/jquery.vmap.world.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/jqvmap/maps/continents/jquery.vmap.africa.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/jqvmap/maps/continents/jquery.vmap.asia.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/jqvmap/maps/continents/jquery.vmap.australia.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/jqvmap/maps/continents/jquery.vmap.europe.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/jqvmap/maps/continents/jquery.vmap.north-america.js');?>"></script>
		<script src="<?php echo base_url('assets/template/vendor/jqvmap/maps/continents/jquery.vmap.south-america.js');?>"></script>
		
		<!-- Theme Base, Components and Settings -->
		<script src="<?php echo base_url('assets/template/javascripts/theme.js');?>"></script>
		
		<!-- Theme Custom -->
		<script src="<?php echo base_url('assets/template/assets/javascripts/theme.custom.js?');?>"></script>
		
		<!-- Theme Initialization Files -->
		<script src="<?php echo base_url('assets/template/javascripts/theme.init.js');?>"></script>


		<!-- Examples -->
		<script src="<?php echo base_url('assets/template/javascripts/dashboard/examples.dashboard.js');?>"></script>
	</body>
</html>