...
<section class="panel panel-warning">
							<header class="panel-heading">
								...
								<h5 style="color:white;">Master Data Set : Edit Master Beneficiary</h5>
							</header>
							<div class="panel-body">


							<a style="margin-bottom: 25px;" class="mb-md mt-xs mr-xs btn btn-warning" href="<?php echo base_url('DataSetBeneficiary');?>">Back</a>

                            <form action="<?php echo base_url('DataSetBeneficiary/save_edit_beneficiary');?>" method="POST">

                            <input type="hidden" value="<?php echo $rowsBeneficiary_byid->BeneficiaryId; ?>" name="beneid" >

                                            <div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Beneficiary Company<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" name="beneficiarydesc" value="<?php echo $rowsBeneficiary_byid->BeneficiaryDesc; ?>" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
											...
											<div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Beneficiary Office<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" name="beneficiary_office" value="<?php echo $rowsBeneficiary_byid->BeneficiaryOffice; ?>" data-plugin-maxlength maxlength="100" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
														<code>max-length</code> set to 100 character.
													</p>
												</div>
											</div>
											
											<div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Beneficiary Address<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" name="beneficiary_addr" value="<?php echo $rowsBeneficiary_byid->BeneficiaryAddr; ?>" data-plugin-maxlength maxlength="100" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
														<code>max-length</code> set to 100 character.
													</p>
												</div>
											...
											<div class="form-group">
												<label class="col-md-4 control-label">Beneficiary Country</label>
												<div class="col-md-8">
                                                    
                                                    <select id="basic" data-plugin-selectTwo class="form-control" name="beneficiary_country" required>
													<option value="<?php echo $rowsBeneficiary_byid->BeneficiaryCountry; ?>">Selected : (<?php echo $rowsBeneficiary_byid->CountryCode;?>) <?php echo $rowsBeneficiary_byid->CountryName; ?></option>
											...
											<div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Beneficiary Contact Person<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" name="beneficiary_contact" value="<?php echo $rowsBeneficiary_byid->BeneficiaryCP; ?>" data-plugin-maxlength maxlength="100" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
														<code>max-length</code> set to 100 character.
													</p>
												</div>
											...
											<div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Beneficiary Phone<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" name="beneficiary_phone" value="<?php echo $rowsBeneficiary_byid->BeneficiaryPhone; ?>" data-plugin-maxlength maxlength="100" required autocomplete="off" />
													<p>
														<code>max-length</code> set to 100 character.
													</p>
												</div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-8">
													<select id="basic" data-plugin-selectTwo class="form-control" name="status_id" required>
                                                        <option value="<?php echo $rowsBeneficiary_byid->BeneficiaryStats; ?>">Selected : 
                                                            <?php if($rowsBeneficiary_byid->BeneficiaryStats=='1'){
                                                                echo "Aktif";
                                                            }else{
                                                                echo "Tidak Aktif";
                                                            } ?> 
