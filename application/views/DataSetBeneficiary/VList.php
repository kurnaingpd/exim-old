...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Master Data Set : Master Beneficiary</h5>
							</header>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-success">
        ...
        <h5 class="modal-title" id="exampleModalLabel">Create Master Beneficiary</h5>
        
      </div>
      <div class="modal-body">

	  <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetBeneficiary/createnewbeneficiary');?>" id="inputdatagroup" method="POST">
                                           
											<div class="form-group">
												<label class="col-md-4 control-label" for="textareaDefault">Beneficiary Company<code>*</code></label>
												<div class="col-md-8">
													<input class="form-control" name="beneficiarydesc" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="beneficiary_office" data-plugin-maxlength maxlength="100" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="beneficiary_addr" data-plugin-maxlength maxlength="100" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
														<code>max-length</code> set to 100 character.
													</p>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="beneficiary_contact" data-plugin-maxlength maxlength="100" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
														<code>max-length</code> set to 100 character.
													</p>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="beneficiary_phone" data-plugin-maxlength maxlength="100" required autocomplete="off" />
													<p>
														<code>max-length</code> set to 100 character.
													</p>
												</div>
...
<!-- End Modal Insert Group -->
								...
								<table class="table table-bordered table-striped mb-none" id="tables3">
									<thead>
										<tr>
											<th>No</th>
											<th>Beneficiary Company</th>
											<th>Beneficiary Office</th>
											<th>Beneficiary Address</th>
											<th>Beneficiary Country</th>
											<th>Beneficiary Contact Person</th>
											<th>Beneficiary Phone</th>
											<th>Beneficiary Stats</th>
											<th>Edit</th>
										</tr>
									</thead>
									<tbody>
...
<?php
if(!empty($lsmasterBeneficiary)){
  // Jika data pada database tidak sama dengan empty (alias ada datanya)
$no_urut=1;
  foreach($lsmasterBeneficiary as $gaa){
    echo "<tr>";
	echo "<th scope='row'>".$no_urut++."</th>";
	echo "<td>".$gaa->BeneficiaryDesc."</td>";
	echo "<td>".$gaa->BeneficiaryOffice."</td>";
	echo "<td>".$gaa->BeneficiaryAddr."</td>";
	echo "<td>( ".$gaa->CountryCode." ) ".$gaa->CountryName."</td>";
	echo "<td>".$gaa->BeneficiaryCP."</td>";
	echo "<td>".$gaa->BeneficiaryPhone."</td>";
	echo "<td>";
		if($gaa->BeneficiaryStats==1){
			echo "Aktif";
		}else{
			echo "Tidak Aktif";
		}
	echo"</td>";
    echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("DataSetBeneficiary/edit_master_beneficiary/".$gaa->BeneficiaryId)."'><i class='fa fa-pencil-square-o'></i></a></td>";
    echo "</tr>";
  }
}
?>
