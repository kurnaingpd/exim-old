...
<section class="panel panel-warning">
							<header class="panel-heading">
								...
								<h5 style="color:white;">Master Data Set : Master Item Mapping</h5>
							</header>
							<div class="panel-body">

<a href="<?php echo base_url('MenuItemMap');?>" class="btn btn-sm btn-warning">Back</a>
<hr>

<form action="<?php echo base_url('MenuItemMap/save_edit_item_mapping');?>" method="POST">

<input type="hidden" name="item_map_id" value="<?php echo $rowsitem_map_byid->gexp_item_map_id; ?>">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-8">
													<select id="item_id" class="form-control" name="item_id" required>
															<option style="font-weight: bold;" value="<?php echo $rowsitem_map_byid->gexp_item_id; ?>">Selected : (<?php echo $rowsitem_map_byid->ItemCodeId; ?>) <?php echo $rowsitem_map_byid->ItemName; ?></option>
														<?php foreach($lsmasteritem as $dt) : ?>
															<option value="<?php echo $dt->ItemId;?>">(<?php echo $dt->ItemCodeId;?>) <?php echo $dt->ItemName;?></option>
														<?php endforeach; ?>
                                                    </select>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-8">
													<select id="country_id" class="form-control" name="country_id" required>
															<option value="<?php echo $rowsitem_map_byid->gexp_country_id; ?>">Selected : (<?php echo $rowsitem_map_byid->CountryCode;?>) <?php echo $rowsitem_map_byid->CountryName;?></option>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-8">
													<select id="status_id" class="form-control" name="status_id" required>
                                                        <option value="<?php echo $rowsitem_map_byid->gexp_item_map_status; ?>">Selected : 
                                                            <?php if($rowsitem_map_byid->gexp_item_map_status=='1'){
                                                                echo "Aktif";
                                                            }else{
                                                                echo "Tidak Aktif";
                                                            } ?> 
