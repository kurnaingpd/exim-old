...
<div class="container-fluid">
	...
	<!-- <a class="btn btn-danger" href="<?php echo base_url('MenuPackingList/packing_list_print/'.$rowdetailspack->gexp_packlist_id); ?>"><i class="fa fa-print"></i> PRINT</a> -->
...
<a class="btn btn-warning" href="<?php echo base_url('MasterBoardPI');?>"><i class="fa fa-arrow-left"></i> Back</a>
				...
				<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('MenuPackingList/InsertCreateNew');?>">

						<div class="container">
							<h4 style="font-weight: bolder;">Create Packing List</h4>
						</div>

                            <hr>

											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Packlist No</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="pl_number" value="<?php echo $noticket."/SKP-EXT/PL/".$m."/".$y; ?>" id="pl_number" readonly required>
												</div>
                                                <label class="col-md-1 control-label" for="inputDefault">Packlist Date</label>
												<div class="col-md-2">
													<input type="date" class="form-control" name="pl_date" value="<?php echo $datenow ?>" id="pl_date" required>
												</div>
                                            ...
                                            <div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Packlist Invoice No</label>
												<div class="col-md-4">
													<select data-plugin-selectTwo class="form-control" name="packlist_inv_id" id="packlist_inv_id" required>
															<option value="">-- Pilih --</option>
														<?php foreach($listDataInvoice as $dt) : ?>
											...
											<div class="form-group">
												...
												<div class="col-md-4">
												<input type="text" class="form-control" name="container_pack" id="container_pack" required>
												</div>
											</div>
