            ...
            <div class="inner-wrapper">
				...
				<aside id="sidebar-left" class="sidebar-left">
					...
					<div class="sidebar-header">
						<div class="sidebar-title" style="background-color: #172774;">
...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Dashboard PL : Packing List</h5>
							</header>
							<div class="panel-body">

<div class="container-fluid">

<a class="btn btn-success" href="<?php echo base_url('MenuPackingList/CreateNew');?>"><i class="fa fa-file"></i> New</a>

</div>

							<hr>

							<form class="form-horizontal form-bordered" method="post" action="<?php echo base_url('MenuPackingList/search');?>">

											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">PL Number</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="pl_number" name="pl_number">
												</div>
											</div>

											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">PL Date</label>
												<div class="col-md-2">
...
$no_urut=1;
  foreach($lspacklist as $gaa){
    echo "<tr>";
	echo "<th scope='row'>".$no_urut++."</th>";
	echo "<td>".$gaa->gexp_packlist_no."</td>";
