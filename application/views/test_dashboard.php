      ...
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="#">
            <img src="<?= base_url(); ?>assets/images/gonusa_600.gif" alt="logo" />
          </a>
          <a class="navbar-brand brand-logo-mini" href="#">
            <img src="<?= base_url(); ?>assets/images/logo-gonusa.png" alt="logo" />
          </a>
        </div>
      </div>
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown"> 
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="countDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                  <img src="<?= base_url(); ?>assets/start/images/faces/face10.jpg" alt="image" class="img-sm profile-pic">
                </div>
                <div class="preview-item-content flex-grow py-2">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                  <img src="<?= base_url(); ?>assets/start/images/faces/face12.jpg" alt="image" class="img-sm profile-pic">
                </div>
                <div class="preview-item-content flex-grow py-2">
                  <p class="preview-subject ellipsis font-weight-medium text-dark">David Grey </p>
                  <p class="<?= base_url(); ?>assets/start/fw-light small-text mb-0"> The meeting is cancelled </p>
                </div>
              </a>
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                  <img src="<?= base_url(); ?>assets/start/images/faces/face1.jpg" alt="image" class="img-sm profile-pic">
                </div>
                <div class="preview-item-content flex-grow py-2">
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle" src="<?= base_url(); ?>assets/start/images/faces/face8.jpg" alt="Profile image"> </a>
          ...
          <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
            ...
            <ul class="chat-list">
              <li class="list active">
                <div class="profile"><img src="<?= base_url(); ?>assets/start/images/faces/face1.jpg" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Thomas Douglas</p>
                  <p>Available</p>
                </div>
              ...
              <li class="list">
                <div class="profile"><img src="<?= base_url(); ?>assets/start/images/faces/face2.jpg" alt="image"><span class="offline"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="<?= base_url(); ?>assets/start/images/faces/face3.jpg" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Daniel Russell</p>
                  <p>Available</p>
                </div>
              ...
              <li class="list">
                <div class="profile"><img src="<?= base_url(); ?>assets/start/images/faces/face4.jpg" alt="image"><span class="offline"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="<?= base_url(); ?>assets/start/images/faces/face5.jpg" alt="image"><span class="online"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="<?= base_url(); ?>assets/start/images/faces/face6.jpg" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Sarah Graves</p>
                  <p>Available</p>
                </div>
                                  ...
                                  <table class="table select-table">
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex ">
                                            <img src="<?= base_url(); ?>assets/start/images/faces/face1.jpg" alt="">
                                            <div>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <img src="<?= base_url(); ?>assets/start/images/faces/face2.jpg" alt="">
                                            <div>
                                              <h6>Laura Brooks</h6>
                                              <p>Head admin</p>
                                            </div>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <img src="<?= base_url(); ?>assets/start/images/faces/face3.jpg" alt="">
                                            <div>
                                              <h6>Wayne Murphy</h6>
                                              <p>Head admin</p>
                                            </div>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <img src="<?= base_url(); ?>assets/start/images/faces/face4.jpg" alt="">
                                            <div>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <img src="<?= base_url(); ?>assets/start/images/faces/face5.jpg" alt="">
                                            <div>
