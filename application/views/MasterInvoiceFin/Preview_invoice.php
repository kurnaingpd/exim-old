...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5> Dashboard Invoice  : Preview Invoice</h5>
							</header>
							<div class="panel-body">

							<a class="btn btn-sm btn-warning" href="<?php echo base_url('MasterInvFin/');?>">Back</a>

							<h3 style="text-align: center;">INVOICE</h3>
							<h5 style="text-align: center;"><?php echo $lsinvoice_byid->gexp_invoice_no; ?></h5>

							<form class="form-horizontal form-bordered" method="get">

											<div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">PI NO</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" value="<?php echo $lsinvoice_byid->gexp_pi_no; ?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">PO NO</label>
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" value="<?php echo $lsinvoice_byid->gexp_pi_po; ?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">Consignee</label>
												<div class="col-md-8">
													<input type="text" class="form-control" id="inputDefault" value="<?php echo $lsinvoice_byid->ConsigPT; ?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-2" for="inputDefault"></label>
												<div class="col-md-8">
													<input type="text" class="form-control" id="inputDefault" value="<?php echo $lsinvoice_byid->ConsigAddr; ?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-2" for="inputDefault"></label>
												<div class="col-md-8">
													<input type="text" class="form-control" id="inputDefault" value="<?php echo $lsinvoice_byid->ConsigCtPhone; ?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-2" for="inputDefault"></label>
												<div class="col-md-8">
													<input type="text" class="form-control" id="inputDefault" value="<?php echo $lsinvoice_byid->ConsigCtName; ?>">
												</div>
											</div>
											<div class="form-group"> 
												<label class="col-md-2 control-label" for="inputDefault">Notify</label>
												<div class="col-md-8">
													<input type="text" class="form-control" id="inputDefault" value="<?php echo $lsinvoice_byid->ConsigPT; ?>">
												</div>
											</div>
											...
											<div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">Shipper</label>
												<div class="col-md-8">
													<input type="text" class="form-control" id="inputDefault" value="<?php echo $lsinvoice_byid->BenePT; ?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-2" for="inputDefault"></label>
												<div class="col-md-8">
													<input type="text" class="form-control" id="inputDefault" value="<?php echo $lsinvoice_byid->BeneAddr; ?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-2" for="inputDefault"></label>
												<div class="col-md-8">
													<input type="text" class="form-control" id="inputDefault" value="<?php echo $lsinvoice_byid->BeneCtPhone; ?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-2" for="inputDefault"></label>
												<div class="col-md-8">
													<input type="text" class="form-control" id="inputDefault" value="<?php echo $lsinvoice_byid->BeneCtName; ?>">
												</div>
											</div>
											<div class="form-group"> 
												<label class="col-md-2 control-label" for="inputDefault">ETD</label>
												<div class="col-md-8">
													<input type="text" class="form-control" id="inputDefault" value="30 Working Days">
												</div>
											</div>
											<div class="form-group"> 
												<label class="col-md-2 control-label" for="inputDefault">DESTINATION</label>
												<div class="col-md-8">
													<input type="text" class="form-control" id="inputDefault" value="<?php echo $lsinvoice_byid->DestinationPort; ?>">
												</div>
											</div>
											<div class="form-group"> 
												<label class="col-md-2 control-label" for="inputDefault">LOADING PORT </label>
												<div class="col-md-8">
													<input type="text" class="form-control" id="inputDefault" value="<?php echo $lsinvoice_byid->LoadPortDesc; ?>">
												</div>
											</div>
											<div class="form-group"> 
												<label class="col-md-2 control-label" for="inputDefault">COUNTRY OF ORIGIN  </label>
												<div class="col-md-8">
													<input type="text" class="form-control" id="inputDefault" value="<?php echo $lsinvoice_byid->CountryName; ?>">
												</div>
											</div>
...
<hr>
<h5 style="font-weight: bold;">Purchase Goods</h5>
							<table class="table table-bordered table-striped mb-none" id="tables3">
									<thead>
										<tr>
											...
											<th>CONTAINER</th>
											<th>HS CODE</th>
											<th class="hidden-phone">DESCRIPTION OF GOODS</th>
...
<?php if($checkvalue_print->inv_print_expired_date=='1'){ ?>
											<th class="hidden-phone">EXP DATE</th>
											<?php } ?>
...
$no_urut=1;
  foreach($lspurchase_goods as $gaa){
	...
	if($checkvalue_print->inv_print_expired_date=='1'){
	echo "<td>".$gaa->gexp_packlistdet_expdate."</td>";
	}
	if($checkvalue_print->inv_print_production_date=='1'){
	...
	// echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("MasterInvFin/invoice_preview/".$gaa->gexp_invoice_id)."'><i class='fa fa-file-o'></i></a></td>";
    // echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("MasterInvFin/invoice_print/".$gaa->gexp_invoice_id)."'><i class='fa fa-print'></i></a></td>";
    echo "</tr>";
  }
...
<h5 style="font-weight: bold;">Free Goods</h5>
							<table class="table table-bordered table-striped mb-none" id="tables3">
									<thead>
										<tr>
										<th>No</th>
...
<?php if($checkvalue_print->inv_print_expired_date=='1'){ ?>
									...
									<?php
if(!empty($lsfree_goods)){
  // Jika data pada database tidak sama dengan empty (alias ada datanya)
$no_urut=1;
  foreach($lsfree_goods as $gaa){
	echo "<tr>";
	echo "<th scope='row'>".$no_urut++."</th>";
	if($checkvalue_print->inv_print_carton_barcode=='1'){
		echo "<td>".$gaa->gexp_packlistdet_carton_bar."</td>";
