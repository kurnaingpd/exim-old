...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5> Dashboard Invoice  : Invoice</h5>
							</header>
							<div class="panel-body">

<div class="container-fluid">

<a class="btn btn-success" href="<?php echo base_url('MasterInvFin/CreateNew');?>"><i class="fa fa-file"></i> New</a>

</div>

							<hr>

							<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('MasterInvFin/SearchingList'); ?>">

											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Invoice Numbers</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="inv_no" id="inputDefault">
												</div>
											</div>

											<!-- <div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Invoice Date</label>
												<div class="col-md-3">
											...
											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Invoice Date</label>
												<div class="col-md-2">
													<input type="date" class="form-control" name="date_a" id="inputDefault">
												</div>
												<label class="col-md-1 control-label" for="inputDefault">To</label>
												<div class="col-md-2">
													<input type="date" class="form-control" name="date_b" id="inputDefault">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" name="customer_name" id="inputDefault">
													<!-- <select id="basic" data-plugin-selectTwo class="form-control" name="customer_name" name="customercountry">
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" name="customer_country" id="inputDefault">
													<!-- <select id="basic" data-plugin-selectTwo class="form-control" name="customer_country" name="customercountry">
															<option value="">-- Pilih --</option> -->
														<!-- <?php foreach($lsmastercountry as $dt) : ?>
															<option value="<?php echo $dt->CountryId;?>">(<?php echo $dt->CountryCode;?>) <?php echo $dt->CountryName;?></option>
														<?php endforeach; ?> -->
								...
								<table class="table table-bordered table-striped mb-none" id="tables3">
									<thead>
										<tr>
											...
											<th>Consignee</th>
											<th>Notify</th>
											<th class="hidden-phone">Shipper</th>
