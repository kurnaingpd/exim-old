...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Finance : Invoice</h5>
							</header>
							<div class="panel-body">

<div class="container-fluid">

<a class="btn btn-warning" href="<?php echo base_url('MasterInvFin');?>"><i class="fa fa-arrow-left"></i> Back</a>

</div>

							<hr>

							<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('MasterInvFin/InsertCreateNew');?>">

<div class="container">
    <h4 style="font-weight: bolder;">Create Invoice</h4>
</div>

                            <hr>

											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Inv No</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="pi_number" value="<?php echo $noticket."/SKP-EXP/INV/".$m."/".$y; ?>" id="inputDefault" readonly>
												</div>
                                                <label class="col-md-1 control-label" for="inputDefault">Inv Date</label>
												<div class="col-md-2">
													<input type="text" class="form-control" name="pi_date" value="<?php echo $datenow ?>" id="inputDefault" readonly>
												</div>
                                                <label class="col-md-1 control-label" for="inputDefault">FFRN #</label>
												<div class="col-md-3">
													<input type="text" class="form-control" name="pi_po" placeholder="Free Text" id="inputDefault" required>
												</div>
											</div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-4">
													<select class="form-control" name="input_customer_id" id="input_customer_id" required>
															<option value="">-- Pilih --</option>
														<?php foreach($listdataPI as $dt) : ?>
															<option value="<?php echo $dt->gexp_pi_id;?>"><?php echo $dt->gexp_pi_no;?></option>
														<?php endforeach; ?>
                                                    </select>
												</div>
											</div>
