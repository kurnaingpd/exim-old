...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Dashboard PI : Approval Proforma Invoice</h5>
							</header>
								...
								<table class="table table-bordered table-striped mb-none" id="tables3">
									<thead>
										<tr>
											...
											<!-- <th class="hidden-phone">Approved By ExpDoc</th> -->
										</tr>
									</thead>
									<tbody>
<?php
...
// APRROVED PI
	...
	// if($gaa->gexp_pi_isApproved=='1' AND $gaa->gexp_pi_statusPI=='1' OR $gaa->gexp_pi_statusPI=='2' OR $gaa->gexp_pi_statusPI=='4' ){
	// 	echo "<td>-</td>";
	// }else{
...
// End Approved PI
	...
	// 	echo "<td>-</td>";
	// }else{
	// 	echo "<td><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' id='anim' href='".base_url("MenuApprovalPI/ApprovedPI_byidexp/".$gaa->gexp_pi_id)."'><i class='fa fa-check-circle-o'></i></a></td>";
	// }
