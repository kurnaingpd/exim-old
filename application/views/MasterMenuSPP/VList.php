...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Dashboard SPP : Surat Penyataan Product</h5>
							</header>
...
<!-- <a class="btn btn-success" href="#"><i class="fa fa-file"></i> New</a> -->
							...
							<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('MenuSPP/save_master_spp');?>">

											<div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">Surat Penyataan Product No</label>
												<div class="col-md-3">
													<input type="text" id="spp_no" name="spp_no" value="<?php echo $noticket."/SKP-EXP/SPP/".$m."/".$y; ?>" class="form-control" readonly required>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" id="nama_spp" name="nama_spp" class="form-control" required>
												</div>
											</div>

											<div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">Jabatan</label>
												<div class="col-md-3">
													<input type="text" id="jabatan_spp" name="jabatan_spp" class="form-control" required>
												</div>
											</div>
...
<br>
								...
								<table class="table table-bordered table-striped mb-none" id="tables3">
									<thead>
										<tr>
											<th>No</th>
											<th>Surat Penyataan Product No</th>
											<th>Invoice No</th>
											<th>Nama</th>
											<th>Jabatan</th>
											<th>Tambah Product</th>
											<th>Tambah Desc</th>
											<th>Print</th>
										</tr>
									</thead>
									<tbody>
<?php
if( ! empty($lsmasterspp)){
  // Jika data pada database tidak sama dengan empty (alias ada datanya)
$no_urut=1;
  foreach($lsmasterspp as $gaa){
    echo "<tr>";
    echo "<th scope='row'>".$no_urut++."</th>";
	echo "<td>".$gaa->gexp_spp_no."</td>";
	echo "<td>".$gaa->gexp_invoice_no."</td>";
	echo "<td>".$gaa->gexp_spp_nama."</td>";
	echo "<td>".$gaa->gexp_spp_jabatan."</td>";
	// echo "<td>";
    // if($gaa->GroupStats==1){
    //   echo "Aktif";
    // }else{
	...
	echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("MenuSPP/view_detail_description/".$gaa->gexp_spp_id)."'><i class='fa fa-plus-circle'></i></a></td>";
	echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("MenuSPP/print_spp/".$gaa->gexp_spp_id)."'><i class='fa fa-print'></i></a></td>";
    echo "</tr>";
  }
