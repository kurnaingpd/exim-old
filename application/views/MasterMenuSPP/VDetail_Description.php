...
<div class="container-fluid">
		...
		<a class="btn btn-warning" href="<?php echo base_url('MenuSPP/');?>"><i class="fa fa-arrow-left"></i> Back</a>
							...
							<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('MenuSPP/save_desc_spp');?>">

											<div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">Surat Penyataan Product No</label>
												<div class="col-md-3">
													<input type="text" name="spp_no" value="<?php echo $rowdetailspp->gexp_spp_no ?>" class="form-control" id="inputDefault" disabled>
												</div>
											</div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="6" data-plugin-maxlength maxlength="140" disabled><?php echo $rowdetailspp->gexp_spp_description ?></textarea>
													<!-- <input type="text" name="nama_dagang_lokal" class="form-control" id="inputDefault"> -->
												</div>
											</div>
											...
											<div class="form-group">
                                                ...
                                                <textarea class="form-control" name="desc" rows="6" data-plugin-maxlength maxlength="1000" required></textarea>
													<!-- <input type="text" name="nama_dagang_lokal" class="form-control" id="inputDefault"> -->
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-2">
													<button type="submit" class="btn btn-block btn-primary"><i class="fa fa-update"></i> Updates</button>
												</div>
											</div>
