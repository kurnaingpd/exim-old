...
<header class="page-header" style="background-color: #172774;">
						<h2>Surat Pernyataan Product</h2>
...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Dashboard Menu SPP : Surat Penyataan Product</h5>
							</header>
							<div class="panel-body">

<div class="container-fluid">

<a class="btn btn-warning" href="<?php echo base_url('MenuSPP/');?>"><i class="fa fa-arrow-left"></i> Back</a>

</div>

							<hr>

							<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('MenuSPP/save_detail_spp');?>">

											<div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">Surat Penyataan Product No</label>
												<div class="col-md-3">
													<input type="text" name="spp_no" value="<?php echo $rowdetailspp->gexp_spp_no ?>" class="form-control" id="inputDefault" readonly>
												</div>
											</div>

											<!-- <div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Surat Penyataan Product Date</label>
												<div class="col-md-2">
											...
											<!-- <div class="form-group">
												...
												<div class="col-md-3">
													<select id="basic" data-plugin-selectTwo class="form-control" name="invoice_no">
															<option value="">-- Pilih --</option>
														<?php foreach($lsinvoice as $dt) : ?>
															<option value="<?php echo $dt->gexp_invoice_id;?>"><?php echo $dt->gexp_invoice_no;?></option>
														<?php endforeach; ?>
                                                    </select>
												</div>
                                            </div> -->
                                            
                                            <input type="hidden" name="headid" value="<?php echo $rowdetailspp->gexp_spp_id ?>" class="form-control" id="inputDefault">

											<div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">Nama Dagang ( Lokal )</label>
												<div class="col-md-3">
													<input type="text" name="nama_dagang_lokal" class="form-control" id="inputDefault" required>
												</div>
											</div>

											<div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">Nama Jenis ( Lokal )</label>
												<div class="col-md-3">
													<input type="text" name="nama_jenis_lokal" class="form-control" id="inputDefault" required>
												</div>
                                            </div>
                                            
                                            <div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">No MD</label>
												<div class="col-md-3">
													<input type="text" name="no_md" class="form-control" id="inputDefault" required>
												</div>
                                            </div>
                                            
                                            <div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">Nama Dagang ( Ekspor )</label>
												<div class="col-md-3">
													<input type="text" name="nama_dagang_ekspor" class="form-control" id="inputDefault" required>
												</div>
											</div>

											<div class="form-group">
												<label class="col-md-2 control-label" for="inputDefault">Nama Jenis ( Ekspor )</label>
												<div class="col-md-3">
													<input type="text" name="nama_jenis_ekspor" class="form-control" id="inputDefault" required>
												</div>
                                            </div>
...
<br>
								...
								<table class="table table-bordered table-striped mb-none" id="tables3">
									<thead>
										<tr>
											<th>No</th>
											<th>Nama Dagang ( Lokal )</th>
											<th>Nama Jenis ( Lokal )</th>
											<th>No MD</th>
											<th>Nama Dagang ( Ekspor )</th>
											<th>Nama Jenis ( Ekspor )</th>
										</tr>
									</thead>
									<tbody>
<?php
...
$no_urut=1;
  foreach($getlistdetails_spp as $gaa){
	...
	echo "<td>".$gaa->spp_nama_dagang_lokal."</td>";
	echo "<td>".$gaa->spp_nama_jenis_lokal."</td>";
	echo "<td>".$gaa->spp_no_md_lokal."</td>";
	echo "<td>".$gaa->spp_nama_dagang_ekspor."</td>";
	echo "<td>".$gaa->spp_nama_jenis_ekspor."</td>";
	// echo "<td>";
    // if($gaa->GroupStats==1){
    //   echo "Aktif";
    // }else{
    ...
    // echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("MenuSPP/view_product_spp/".$gaa->gexp_spp_id)."'><i class='fa fa-plus-circle'></i></a></td>";
    echo "</tr>";
  }
