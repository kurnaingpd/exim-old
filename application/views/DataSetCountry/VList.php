...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetCountry/createnewcountry');?>" id="inputdatagroup" method="POST">
                                           
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Country Code</label>
												<div class="col-md-8">
													<input class="form-control" name="countrycode" data-plugin-maxlength maxlength="50" autocomplete="off" required style="text-transform: uppercase" />
													<p>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="countryname" data-plugin-maxlength maxlength="50" autocomplete="off" required style="text-transform: uppercase" />
													<!-- <p>
