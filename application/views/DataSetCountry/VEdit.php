...
<section class="panel panel-warning">
            ...
            <header class="panel-heading">
                ...
                <h5 style="color: white;">Master Data Set : Master Set Country</h5>

            </header>
            <div class="panel-body">

            <a style="margin-bottom: 25px;" class="mb-md mt-xs mr-xs btn btn-warning" href="<?php echo base_url('DataSetCountry');?>">Back</a>
...
<h5 class="modal-title" id="exampleModalLabel">Edit Master Country</h5>

</div>
<div class="modal-body">

<form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetCountry/submiteditmastercountry');?>" id="inputdatagroup" method="POST">

                    <input type="hidden" value="<?php echo $lsmastercountry[0]->CountryId ?>" name="countryid">
                           
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="textareaDefault">Country Code</label>
                                <div class="col-md-8">
                                    <input class="form-control" name="countrycode" value="<?php echo $lsmastercountry[0]->CountryCode ?>" data-plugin-maxlength maxlength="50" autocomplete="off" required style="text-transform: uppercase" />
                                    <p>
                                        <code>*</code>.
                                    </p>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="textareaDefault">Country Name</label>
                                <div class="col-md-8">
                                    <input class="form-control" name="countryname" value="<?php echo $lsmastercountry[0]->CountryName ?>" data-plugin-maxlength maxlength="50" autocomplete="off" required style="text-transform: uppercase" />
                                    <p>
                                        <code>*</code>.
                                    </p>
                                    <!-- <p>
                            ...
                            <div class="form-group">
												...
												<div class="col-md-8">
													<select id="basic" data-plugin-selectTwo class="form-control" name="countrystats">
                                                            <option value="<?php echo $lsmastercountry[0]->CountryStats ?>"><b>Selected : </b><?php if($lsmastercountry[0]->CountryStats=='1'){
                                                                echo "Active";
                                                            }else{
                                                                echo "InActive";
                                                            } ?></option>
