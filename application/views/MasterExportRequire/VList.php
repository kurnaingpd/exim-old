...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Ketentuan Export : Export Require</h5>
							</header>
							<div class="panel-body">

<div class="container-fluid">

<a class="btn btn-success" href="<?php echo base_url('ExportRequire/createNew'); ?>"><i class="fa fa-file"></i> New</a>
							...
							<form class="form-horizontal form-bordered" method="get">
											...
											<div class="form-group">
												<label class="col-md-1 control-label" for="inputDefault">Export Req Numbers</label>
												<div class="col-md-3">
