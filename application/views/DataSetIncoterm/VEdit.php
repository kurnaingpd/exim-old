...
<section class="panel panel-warning">
            ...
            <header class="panel-heading">
                ...
                <h5 style="color: white;">Master Data Set : Master Set INCOTERM</h5>

            </header>
            <div class="panel-body">

            <a style="margin-bottom: 25px;" class="mb-md mt-xs mr-xs btn btn-warning" href="<?php echo base_url('DataSetIncoterm/');?>">Back</a>
...
<h5 class="modal-title" id="exampleModalLabel">EDIT MASTER INCOTERM</h5>

</div>
<div class="modal-body">

<form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetIncoterm/submiteditmasterinco');?>" id="inputdatagroup" method="POST">

                    <input type="hidden" value="<?php echo $lsmasterinco[0]->IncotermId ?>" name="incoid">

                            <div class="form-group">
                                <label class="col-md-3 control-label" for="textareaDefault">Incoterm Code</label>
                                <div class="col-md-8">
                                    <input class="form-control" name="incocode" value="<?php echo $lsmasterinco[0]->IncotermCode ?>" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" />
                                    <p>
                                        <code>*</code>.
                                    </p>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="textareaDefault">Incoterm Desc</label>
                                <div class="col-md-8">
                                    <input class="form-control" name="incodesc" value="<?php echo $lsmasterinco[0]->IncotermDesc ?>" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" />
                                    <p>
                                        <code>*</code>.
                                    </p>
                                </div>
                            ...
                            <div class="form-group">
												...
												<div class="col-md-8">
													<select id="basic" data-plugin-selectTwo class="form-control" name="incostats">
                                                            <option value="<?php echo $lsmasterinco[0]->IncotermStats ?>"><b>Selected : </b><?php if($lsmasterinco[0]->IncotermStats=='1'){
                                                                echo "Active";
                                                            }else{
                                                                echo "InActive";
                                                            } ?></option>
...
// echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("DataSetCountry/Editmastercountry/".$gaa->CountryId)."'><i class='fa fa-pencil-square-o'></i></a></td>";
echo "</tr>";
}
