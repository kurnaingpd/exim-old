...
<section class="panel panel-primary">
							<header class="panel-heading">
								...
								<h5>Master Data Set : Master Incoterm</h5>
							</header>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-success">
        ...
        <h5 class="modal-title" id="exampleModalLabel">Create Master Incoterm</h5>
        
      </div>
      <div class="modal-body">

	  <form class="form-horizontal form-bordered form-bordered" action="<?php echo base_url('DataSetIncoterm/createnewinco');?>" id="inputdatagroup" method="POST">
                                           
											<div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Incoterm Code</label>
												<div class="col-md-8">
													<input class="form-control" name="incocode" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input class="form-control" name="incodesc" data-plugin-maxlength maxlength="50" required autocomplete="off" style="text-transform: uppercase;" />
													<p>
														<code>max-length</code> set to 50 character <code>uppercase</code>.
													</p>
												</div>
...
$no_urut=1;
  foreach($lsmasterinco as $gaa){
    ...
    echo "<td style='text-align:center; font-size:18px;'><a style='font-size:18px;' class='btn small-btn-ic-info shadow-sm' href='".base_url("DataSetIncoterm/Editmasterinco/".$gaa->IncotermId)."'><i class='fa fa-pencil-square-o'></i></a></td>";
    echo "</tr>";
  }
