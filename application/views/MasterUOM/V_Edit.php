...
<a class="mb-xs mt-xs mr-xs btn btn-warning" style="width:150px;" href="<?php echo base_url('MasterUOM/'); ?>"><i class="fa fa-arrow-left"></i> Back</a>
...
<div class="row">
<br>
<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('MasterUom/submit_edit_data'); ?>">

<input type="hidden" name="uom_id" value="<?php echo $rows_Uom->mt_uom_id ?>" class="form-control" id="inputDefault" required>

                                            
											<div class="form-group">
                                                <label class="col-md-1" for="inputDefault"></label>
												<label style="font-weight: 600; color:black; border-style:solid; border-color:#172774; padding:10px; border-width:0.5px; background-color:white;" class="col-md-12" for="inputDefault">Edit Master UOM</label>
												<!-- <div class="col-md-3">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="uom_name" value="<?php echo $rows_Uom->mt_uom_name ?>" required>
												</div>
                                            </div>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
                                                    ...
                                                    <option value="<?php echo $rows_Uom->mt_uom_stats ?>">Selected : <?php if($rows_Uom->mt_uom_stats=='1'){
                                                                echo "Active";
                                                            }else{
                                                                echo "Not Active";
                                                            } ?></option>
