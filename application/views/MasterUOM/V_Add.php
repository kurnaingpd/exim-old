...
<div class="row">
<br>
<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url('MasterUom/submit_tambah_data'); ?>">
											...
											<div class="form-group">
												...
												<label style="font-weight: 600; color:black; border-style:solid; border-color:#172774; padding:10px; border-width:0.5px; background-color:white;" class="col-md-12" for="inputDefault">Tambah Master UOM</label>
												<!-- <div class="col-md-3">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" class="form-control" id="inputDefault" name="uom_name" required>
												</div>
                                            </div>
                                            ...
                                            <!-- <div class="form-group">
												...
												<div class="col-md-3">
													<select id="basic" data-plugin-selectTwo class="form-control" name="status">
