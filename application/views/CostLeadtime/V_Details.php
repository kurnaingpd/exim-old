...
<h5 class="panel-title"><strong>INFORMATION : GDA IMPORTATION</strong></h5>
...
<section class="panel panel-featured panel-featured-primary">
								<header class="panel-heading">
									...
									<h2 class="panel-title">TAHUN : 2018</h2>
								</header>
	<div class="panel-body">

<!-- <a href="#" class="btn btn-primary"> PREVIEW </a> -->

<h5 style="color: black;"><strong> Value ( in bn IDR ) </strong></h5>

<div class="form-group">
	<label class="col-md-2 control-label" style="font-weight: 600; color:black;" for="inputDefault">MACHINE</label>
		<div class="col-md-4">
			<input type="text" class="form-control" id="inputDefault" value="0.74" readonly>
		</div>
</div>
<div class="form-group">
	<label class="col-md-2 control-label" style="font-weight: 600; color:black;" for="inputDefault">HAY</label>
		<div class="col-md-4">
			<input type="text" class="form-control" id="inputDefault" value="-" readonly>
		</div>
</div>
<div class="form-group">
	<label class="col-md-2 control-label" style="font-weight: 600; color:black;" for="inputDefault">MATERIAL</label>
		<div class="col-md-4">
			<input type="text" class="form-control" id="inputDefault" value="-" readonly>
		</div>
</div>
<div class="form-group">
	<label class="col-md-2 control-label" style="font-weight: 600; color:black;" for="inputDefault">SPARE PART</label>
		<div class="col-md-4">
			<input type="text" class="form-control" id="inputDefault" value="-" readonly>
		</div>
</div>
...
<h5 style="color: black;"><strong> Landed Cost ( % ) </strong></h5>

<div class="form-group">
	<label class="col-md-2 control-label" style="font-weight: 600; color:black;" for="inputDefault">MACHINE</label>
		<div class="col-md-4">
			<input type="text" class="form-control" id="inputDefault" value="23.67 %" readonly>
		</div>
</div>
<div class="form-group">
	<label class="col-md-2 control-label" style="font-weight: 600; color:black;" for="inputDefault">HAY</label>
...
<h5 style="color: black;"><strong> Leadtime ( days ) </strong></h5>

<div class="form-group">
	<label class="col-md-2 control-label" style="font-weight: 600; color:black;" for="inputDefault">MACHINE</label>
		<div class="col-md-4">
			<input type="text" class="form-control" id="inputDefault" value="12.67" readonly>
		</div>
</div>
<div class="form-group">
	<label class="col-md-2 control-label" style="font-weight: 600; color:black;" for="inputDefault">HAY</label>
...
<section class="panel panel-featured panel-featured-primary">
								<header class="panel-heading">
									...
									<h2 class="panel-title">TAHUN : 2019</h2>
								</header>
	<div class="panel-body">
...
<section class="panel panel-featured panel-featured-primary">
								<header class="panel-heading">
									...
									<h2 class="panel-title">TAHUN : 2020</h2>
								</header>
	<div class="panel-body">
...
<section class="panel panel-featured panel-featured-primary">
								<header class="panel-heading">
									...
									<h2 class="panel-title">TAHUN : 2021</h2>
								</header>
	<div class="panel-body">
