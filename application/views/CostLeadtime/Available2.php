...
<div class="card">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-1">
           <a class="btn btn-warning" style="width:150px;" href="<?php echo base_url('Cost_Leadtime/Details_CLT_1'); ?>">Back</a>
      </div>
      <div class="col-lg-1">
...
<section class="panel panel-featured panel-featured-primary">
								<header class="panel-heading">
									...
									<h2 class="panel-title"><i class="fa fa-cube"></i> PTB IMPORTATION</h2>
								</header>
