...
<section class="panel panel-featured panel-featured-primary">
								<header class="panel-heading">
									...
									<h2 class="panel-title">GDA IMPORTATION</h2>
								</header>
	<div class="panel-body">

<a href="<?php echo base_url('Cost_Leadtime/Details_CLT_1'); ?>" class="btn btn-primary"> GET REPORT </a>
...
<section class="panel panel-featured panel-featured-primary">
								<header class="panel-heading">
									...
									<h2 class="panel-title">PTB IMPORTATION</h2>
								</header>
	<div class="panel-body">

<a href="<?php echo base_url('Cost_Leadtime/Details_CLT_2'); ?>" class="btn btn-primary"> GET REPORT </a>
...
<section class="panel panel-featured panel-featured-primary">
								<header class="panel-heading">
									...
									<h2 class="panel-title">SKP IMPORTATION</h2>
								</header>
	<div class="panel-body">

<a href="<?php echo base_url('Cost_Leadtime/Details_CLT_3'); ?>" class="btn btn-primary"> GET REPORT </a>
