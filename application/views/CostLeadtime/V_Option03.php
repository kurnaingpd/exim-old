...
<a class="btn btn-warning" style="width:150px;"  href="<?php echo base_url('Cost_Leadtime/'); ?>"><i class="fa fa-arrow-left"></i> Back</a>

<br>
<br>
<!-- Content Start -->

<h5 class="panel-title"><strong>INFORMATION : SKP IMPORTATION</strong></h5>

<br>


<form method="POST" action="<?php echo base_url('Cost_Leadtime/validop03'); ?>">

                                            <div class="form-group">
												<label class="col-md-1 control-label" style="font-weight: 600; color:black;" for="inputDefault">Start Years</label>
												<div class="col-md-2">
                                                    <!-- <input type="date" class="form-control" id="inputDefault" name="start_deliv"> -->
                                                    <select data-plugin-selectTwo class="form-control" name="start_years">
															<option value="">-- Pilih --</option>
														<?php foreach($years_data as $dt) : ?>
															<option value="<?php echo $dt->tahun_data?>"><?php echo $dt->tahun_data;?></option>
														<?php endforeach; ?>
                                                    </select>
												</div>
												<label class="col-md-1 control-label" style="font-weight: 600; color:black;" for="inputDefault">Finish Years</label>
												<div class="col-md-2">
                                                    <!-- <input type="date" class="form-control" id="inputDefault" name="end_deliv"> -->
                                                    <select data-plugin-selectTwo class="form-control" name="finish_years">
															<option value="">-- Pilih --</option>
														<?php foreach($years_data as $dt) : ?>
															<option value="<?php echo $dt->tahun_data?>"><?php echo $dt->tahun_data;?></option>
														<?php endforeach; ?>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-2">
													<button type="submit" class="btn btn-block btn-primary"><i class="fa fa-file-archive-o"></i>  Generated</button>
												</div>
                                            </div>
